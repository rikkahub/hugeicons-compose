...
val HugeIcons.BadgeDollarSign: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(9f, 14f)
            curveTo(9f, 15.1429f, 10.25f, 16f, 12f, 16f)
            curveTo(13.75f, 16f, 15f, 15.4074f, 15f, 13.9259f)
            curveTo(15f, 12.4444f, 14f, 11.8519f, 12f, 11.8519f)
            curveTo(10f, 11.8519f, 9.25f, 11.2196f, 9.25f, 10.0741f)
            curveTo(9.25f, 8.92859f, 10.4812f, 8f, 12f, 8f)
            curveTo(13.2547f, 8f, 14.3132f, 8.63376f, 14.6433f, 9.5f)
        }
