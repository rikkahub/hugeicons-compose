...
val HugeIcons.PhoneIncoming: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(14.7252f, 9.26892f)
            lineTo(19.9922f, 4.00195f)
            moveTo(18.9922f, 9.70596f)
            curveTo(17.7368f, 9.81518f, 14.9453f, 10.3246f, 14.3074f, 9.68671f)
            curveTo(13.6695f, 9.04884f, 14.179f, 6.25729f, 14.2882f, 5.00195f)
        }
        }.build()
