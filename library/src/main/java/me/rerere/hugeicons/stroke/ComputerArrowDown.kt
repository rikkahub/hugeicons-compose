...
val HugeIcons.ComputerArrowDown: ImageVector
    get() {
        if (_computerArrowDown != null) {
            return _computerArrowDown!!
        }
        _computerArrowDown = ImageVector.Builder(
            name = "ComputerArrowDown",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _computerArrowDown: ImageVector? = null
