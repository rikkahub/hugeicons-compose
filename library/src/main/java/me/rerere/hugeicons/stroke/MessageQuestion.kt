...
val HugeIcons.MessageQuestion: ImageVector
    get() {
        ...
        moveTo(10.5f, 9.53846f)
        curveTo(10.5f, 8.68879f, 11.1716f, 8f, 12f, 8f)
        curveTo(12.8284f, 8f, 13.5f, 8.68879f, 13.5f, 9.53846f)
        curveTo(13.5f, 9.84473f, 13.4127f, 10.1301f, 13.2623f, 10.3698f)
        curveTo(12.8141f, 11.0844f, 12f, 11.7657f, 12f, 12.6154f)
        verticalLineTo(13f)
        }
