...
val HugeIcons.ScanSearch: ImageVector
    get() {
        if (_scanSearch != null) {
            return _scanSearch!!
        }
        ...
        path(
            ...
            moveTo(15.4922f, 15f)
            lineTo(17.4922f, 17f)
            moveTo(16.4922f, 11.5f)
            curveTo(16.4922f, 9.01472f, 14.4775f, 7f, 11.9922f, 7f)
            curveTo(9.50691f, 7f, 7.49219f, 9.01472f, 7.49219f, 11.5f)
            curveTo(7.49219f, 13.9853f, 9.50691f, 16f, 11.9922f, 16f)
            curveTo(14.4775f, 16f, 16.4922f, 13.9853f, 16.4922f, 11.5f)
            close()
        }
