...
val HugeIcons.TropicalStormTracks02: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(10.336860000000001f, 10.312f)
            arcTo(2.23093f, 2.23093f, 0f, true, false, 5.875000000000001f, 10.312f)
            arcTo(2.23093f, 2.23093f, 0f, true, false, 10.336860000000001f, 10.312f)
            close()
        }
