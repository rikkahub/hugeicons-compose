...
val HugeIcons.FunnelX: ImageVector
    get() {
        if (_funnelX != null) {
            return _funnelX!!
        }
        ...
        path(
            ...
            curveTo(16.196f, 11.8709f, 16.348f, 11.7496f, 16.5f, 11.6283f)
        }
        ...
        path(
            ...
            moveTo(21.9917f, 3.25f)
            lineTo(19.5f, 5.74583f)
            moveTo(19.5f, 5.74583f)
            lineTo(17f, 8.25f)
            moveTo(19.5f, 5.74583f)
            lineTo(22f, 8.25f)
            moveTo(19.5f, 5.74583f)
            lineTo(17.0083f, 3.25f)
        }
        }.build()
