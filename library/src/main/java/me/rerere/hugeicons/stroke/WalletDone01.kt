...
val HugeIcons.WalletDone01: ImageVector
    get() {
        if (_walletDone01 != null) {
            return _walletDone01!!
        }
        _walletDone01 = ImageVector.Builder(
            name = "WalletDone01",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(3f, 19f)
        curveTo(3f, 19f, 4f, 19f, 5f, 21f)
        curveTo(5f, 21f, 8.17647f, 16f, 11f, 15f)
        }
        }.build()
...
private var _walletDone01: ImageVector? = null
