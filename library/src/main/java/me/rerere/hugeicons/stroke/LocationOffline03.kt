...
val HugeIcons.LocationOffline03: ImageVector
    get() {
        if (_locationOffline03 != null) {
            return _locationOffline03!!
        }
        _locationOffline03 = ImageVector.Builder(
        ...
        path(
            ...
            moveTo(14f, 14f)
            curveTo(13.4732f, 14.3174f, 12.6598f, 14.5f, 12f, 14.5f)
            curveTo(10.067f, 14.5f, 8.5f, 12.933f, 8.5f, 11f)
            curveTo(8.5f, 10.3402f, 8.68259f, 9.52677f, 9f, 9f)
        }
...
private var _locationOffline03: ImageVector? = null
