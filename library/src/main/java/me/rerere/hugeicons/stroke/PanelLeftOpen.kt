...
val HugeIcons.PanelLeftOpen: ImageVector
    get() {
        ...
        moveTo(16f, 9f)
        lineTo(14.8918f, 9.87868f)
        curveTo(13.6306f, 10.8787f, 13f, 11.3787f, 13f, 12f)
        curveTo(13f, 12.6213f, 13.6306f, 13.1213f, 14.8918f, 14.1213f)
        lineTo(16f, 15f)
        }
        }.build()
