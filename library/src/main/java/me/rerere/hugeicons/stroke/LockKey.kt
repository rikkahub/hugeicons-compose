...
val HugeIcons.LockKey: ImageVector
    get() {
        ...
        curveTo(5.25872f, 9.04653f, 3.35629f, 9.2716f, 2.48017f, 11.3472f)
        curveTo(1.90444f, 13.0976f, 1.87941f, 16.7736f, 2.22986f, 18.6241f)
        curveTo(2.30495f, 19.5744f, 2.80559f, 20.8998f, 4.35757f, 21.6f)
        curveTo(5.30878f, 22.1001f, 6.83573f, 21.9f, 7.98719f, 22.0001f)
        moveTo(5.98464f, 8.1963f)
        ...
        moveTo(15.225f, 17.7909f)
        lineTo(17.2156f, 15.8482f)
        moveTo(22f, 15.8482f)
        lineTo(20.3731f, 14.3089f)
        curveTo(19.6f, 13.5692f, 18.95f, 14.2149f, 18.6264f, 14.4906f)
        lineTo(17.2156f, 15.8482f)
        moveTo(17.2156f, 15.8482f)
        lineTo(18.825f, 17.3936f)
        }
        }.build()
