...
val HugeIcons.PackageReceive01: ImageVector
    get() {
        if (_packageReceive01 != null) {
            return _packageReceive01!!
        }
        _packageReceive01 = ImageVector.Builder(
            name = "PackageReceive01",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
        ...
        moveTo(21.5f, 18.5f)
        curveTo(21.5f, 18.5f, 19.2905f, 21.5f, 18.5f, 21.5f)
...
private var _packageReceive01: ImageVector? = null
