...
val HugeIcons.RubberDuck: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(8.24927f, 6.25f)
            horizontalLineTo(8.37427f)
            moveTo(8.49927f, 6.25f)
            curveTo(8.49927f, 6.11193f, 8.38734f, 6f, 8.24927f, 6f)
            curveTo(8.1112f, 6f, 7.99927f, 6.11193f, 7.99927f, 6.25f)
            curveTo(7.99927f, 6.38807f, 8.1112f, 6.5f, 8.24927f, 6.5f)
            curveTo(8.38734f, 6.5f, 8.49927f, 6.38807f, 8.49927f, 6.25f)
            close()
        }
        }.build()
