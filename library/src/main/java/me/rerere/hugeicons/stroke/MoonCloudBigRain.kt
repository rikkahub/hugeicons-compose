...
val HugeIcons.MoonCloudBigRain: ImageVector
    get() {
        if (_moonCloudBigRain != null) {
            return _moonCloudBigRain!!
        }
        _moonCloudBigRain = ImageVector.Builder(
...
private var _moonCloudBigRain: ImageVector? = null
