...
val HugeIcons.WifiLowSignal: ImageVector
    get() {
        if (_wifiLowSignal != null) {
            return _wifiLowSignal!!
        }
        _wifiLowSignal = ImageVector.Builder(
            name = "WifiLowSignal",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _wifiLowSignal: ImageVector? = null
