...
val HugeIcons.ChatDownload: ImageVector
    get() {
        if (_chatDownload != null) {
            return _chatDownload!!
        }
        _chatDownload = ImageVector.Builder(
            name = "ChatDownload",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(15.0001f, 11f)
        curveTo(15.0001f, 11f, 12.7906f, 14f, 12f, 14f)
        curveTo(11.2095f, 14f, 9.00006f, 11f, 9.00006f, 11f)
        moveTo(12f, 13.5f)
        verticalLineTo(7f)
        }
        }.build()
...
private var _chatDownload: ImageVector? = null
