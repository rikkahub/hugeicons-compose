...
val HugeIcons.Rar01: ImageVector
    get() {
        if (_rar01 != null) {
            return _rar01!!
        }
        _rar01 = ImageVector.Builder(
            name = "Rar01",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            curveTo(19.3284f, 16f, 20f, 16.6716f, 20f, 17.5f)
            curveTo(20f, 18.3284f, 19.3284f, 19f, 18.5f, 19f)
...
private var _rar01: ImageVector? = null
