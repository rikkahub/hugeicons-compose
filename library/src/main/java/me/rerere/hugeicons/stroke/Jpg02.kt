...
val HugeIcons.Jpg02: ImageVector
    get() {
        if (_jpg02 != null) {
            return _jpg02!!
        }
        _jpg02 = ImageVector.Builder(
            name = "Jpg02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(21f, 15f)
        curveTo(21f, 14.4477f, 20.5523f, 14f, 20f, 14f)
        horizontalLineTo(18.5f)
        curveTo(17.9477f, 14f, 17.5f, 14.4477f, 17.5f, 15f)
        verticalLineTo(18f)
        curveTo(17.5f, 18.5523f, 17.9477f, 19f, 18.5f, 19f)
        horizontalLineTo(20f)
        curveTo(20.5523f, 19f, 21f, 18.5523f, 21f, 18f)
        verticalLineTo(17f)
        horizontalLineTo(20f)
        moveTo(10.5f, 14f)
        verticalLineTo(17.25f)
        curveTo(10.5f, 18.2165f, 9.7165f, 19f, 8.75f, 19f)
        horizontalLineTo(8.66667f)
        curveTo(7.74619f, 19f, 7f, 18.2538f, 7f, 17.3333f)
        moveTo(12.5f, 19f)
        verticalLineTo(17f)
        moveTo(12.5f, 17f)
        verticalLineTo(15f)
        curveTo(12.5f, 14.4477f, 12.9477f, 14f, 13.5f, 14f)
        horizontalLineTo(14f)
        curveTo(14.8284f, 14f, 15.5f, 14.6716f, 15.5f, 15.5f)
        curveTo(15.5f, 16.3284f, 14.8284f, 17f, 14f, 17f)
...
private var _jpg02: ImageVector? = null
