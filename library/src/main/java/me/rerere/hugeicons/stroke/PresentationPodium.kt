...
val HugeIcons.PresentationPodium: ImageVector
    get() {
        if (_presentationPodium != null) {
            return _presentationPodium!!
        }
        _presentationPodium = ImageVector.Builder(
...
private var _presentationPodium: ImageVector? = null
