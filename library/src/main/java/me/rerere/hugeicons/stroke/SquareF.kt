...
val HugeIcons.SquareF: ImageVector
    get() {
        if (_squareF != null) {
            return _squareF!!
        }
        _squareF = ImageVector.Builder(
            name = "SquareF",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        curveTo(10.5858f, 7.5f, 9.87868f, 7.5f, 9.43934f, 7.93934f)
        curveTo(9f, 8.37868f, 9f, 9.08579f, 9f, 10.5f)
        verticalLineTo(17f)
        }
