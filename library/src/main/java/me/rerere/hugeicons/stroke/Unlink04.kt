...
val HugeIcons.Unlink04: ImageVector
    get() {
        if (_unlink04 != null) {
            return _unlink04!!
        }
        _unlink04 = ImageVector.Builder(
            name = "Unlink04",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            moveTo(21.0001f, 16f)
            horizontalLineTo(18.9212f)
            moveTo(16.0001f, 21f)
            lineTo(16.0001f, 18.9211f)
        }
        ...
        path(
            ...
            moveTo(3.00009f, 8f)
            horizontalLineTo(5.07898f)
            moveTo(8.00009f, 3f)
            lineTo(8.00009f, 5.07889f)
        }
        }.build()
...
private var _unlink04: ImageVector? = null
