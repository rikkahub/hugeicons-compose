...
val HugeIcons.BellMinus: ImageVector
    get() {
        if (_bellMinus != null) {
            return _bellMinus!!
        }
        ...
        path(
            ...
            moveTo(17f, 4.03182f)
            curveTo(15.9824f, 2.87832f, 14.5278f, 2.12006f, 12.892f, 2.01285f)
            ...
            curveTo(21.3467f, 16.559f, 21.1194f, 16.2749f, 20.6648f, 15.7066f)
            lineTo(20.4951f, 15.4944f)
            curveTo(20.0392f, 14.9246f, 19.8113f, 14.6397f, 19.6184f, 14.3409f)
            curveTo(19.1557f, 13.624f, 18.8291f, 12.8305f, 18.6525f, 12f)
        }
