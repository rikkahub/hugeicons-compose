...
val HugeIcons.InfinitySquare: ImageVector
    get() {
        if (_infinitySquare != null) {
            return _infinitySquare!!
        }
        _infinitySquare = ImageVector.Builder(
            name = "InfinitySquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _infinitySquare: ImageVector? = null
