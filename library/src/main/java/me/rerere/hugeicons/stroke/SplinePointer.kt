...
val HugeIcons.SplinePointer: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(20.5f, 4.5f)
            arcTo(2f, 2f, 0f, true, false, 16.5f, 4.5f)
            arcTo(2f, 2f, 0f, true, false, 20.5f, 4.5f)
            close()
        }
        ...
        path(
            ...
            moveTo(6.5f, 18.5f)
            arcTo(2f, 2f, 0f, true, false, 2.5f, 18.5f)
            arcTo(2f, 2f, 0f, true, false, 6.5f, 18.5f)
            close()
        }
        ...
        path(
            ...
            moveTo(4.5f, 16.5f)
            curveTo(4.5f, 9.87258f, 9.87258f, 4.5f, 16.5f, 4.5f)
        }
