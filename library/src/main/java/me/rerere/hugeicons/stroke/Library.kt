...
val HugeIcons.Library: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(17.9062f, 16.6934f)
            horizontalLineTo(17.7812f)
            moveTo(18.0312f, 16.6934f)
            curveTo(18.0312f, 16.8314f, 17.9193f, 16.9434f, 17.7812f, 16.9434f)
            curveTo(17.6432f, 16.9434f, 17.5312f, 16.8314f, 17.5312f, 16.6934f)
            curveTo(17.5312f, 16.5553f, 17.6432f, 16.4434f, 17.7812f, 16.4434f)
            curveTo(17.9193f, 16.4434f, 18.0312f, 16.5553f, 18.0312f, 16.6934f)
            close()
        }
