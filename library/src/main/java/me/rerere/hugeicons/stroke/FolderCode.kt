...
val HugeIcons.FolderCode: ImageVector
    get() {
        if (_folderCode != null) {
            return _folderCode!!
        }
        ...
        path(
            ...
            moveTo(14f, 17f)
            curveTo(14f, 17f, 17f, 14.7905f, 17f, 14f)
            curveTo(17f, 13.2094f, 14f, 11f, 14f, 11f)
        }
        ...
        path(
            ...
            moveTo(9.99998f, 17f)
            curveTo(9.99998f, 17f, 7.00001f, 14.7905f, 7f, 14f)
            curveTo(6.99999f, 13.2094f, 10f, 11f, 10f, 11f)
        }
        }.build()
