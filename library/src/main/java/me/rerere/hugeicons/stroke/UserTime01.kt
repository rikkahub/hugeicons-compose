...
val HugeIcons.UserTime01: ImageVector
    get() {
        ...
        verticalLineTo(16f)
        moveTo(21.5f, 17.5f)
        curveTo(21.5f, 19.433f, 19.933f, 21f, 18f, 21f)
        curveTo(16.067f, 21f, 14.5f, 19.433f, 14.5f, 17.5f)
        curveTo(14.5f, 15.567f, 16.067f, 14f, 18f, 14f)
        curveTo(19.933f, 14f, 21.5f, 15.567f, 21.5f, 17.5f)
        }
        }.build()
