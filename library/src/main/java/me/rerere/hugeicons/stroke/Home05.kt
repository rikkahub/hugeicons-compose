...
val HugeIcons.Home05: ImageVector
    get() {
        ...
        moveTo(14f, 15f)
        curveTo(14f, 13.8954f, 13.1046f, 13f, 12f, 13f)
        curveTo(10.8954f, 13f, 10f, 13.8954f, 10f, 15f)
        curveTo(10f, 16.1046f, 10.8954f, 17f, 12f, 17f)
        curveTo(13.1046f, 17f, 14f, 16.1046f, 14f, 15f)
        }
        }.build()
