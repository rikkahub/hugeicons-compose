...
val HugeIcons.ChatSearch: ImageVector
    get() {
        if (_chatSearch != null) {
            return _chatSearch!!
        }
        _chatSearch = ImageVector.Builder(
            name = "ChatSearch",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(16f, 13.9998f)
        lineTo(14.375f, 12.3748f)
        moveTo(15f, 9.99976f)
        curveTo(15f, 8.3429f, 13.6569f, 6.99976f, 12f, 6.99976f)
        curveTo(10.3431f, 6.99976f, 9f, 8.3429f, 9f, 9.99976f)
        curveTo(9f, 11.6566f, 10.3431f, 12.9998f, 12f, 12.9998f)
        curveTo(12.8284f, 12.9998f, 13.5784f, 12.664f, 14.1213f, 12.1211f)
        curveTo(14.6642f, 11.5782f, 15f, 10.8282f, 15f, 9.99976f)
        }
        }.build()
...
private var _chatSearch: ImageVector? = null
