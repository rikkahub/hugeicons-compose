...
val HugeIcons.BitcoinPieChart: ImageVector
    get() {
        if (_bitcoinPieChart != null) {
            return _bitcoinPieChart!!
        }
        _bitcoinPieChart = ImageVector.Builder(
...
private var _bitcoinPieChart: ImageVector? = null
