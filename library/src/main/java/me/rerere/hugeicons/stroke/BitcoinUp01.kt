...
val HugeIcons.BitcoinUp01: ImageVector
    get() {
        ...
        moveTo(12f, 8.99988f)
        curveTo(8.41012f, 8.99988f, 5.49997f, 11.91f, 5.49997f, 15.4999f)
        curveTo(5.49997f, 19.0897f, 8.41012f, 21.9999f, 12f, 21.9999f)
        ...
        moveTo(9.49998f, 4.49988f)
        curveTo(9.99151f, 3.99418f, 11.2998f, 1.99988f, 12f, 1.99988f)
        moveTo(12f, 1.99988f)
        lineTo(12f, 6.49988f)
        }
