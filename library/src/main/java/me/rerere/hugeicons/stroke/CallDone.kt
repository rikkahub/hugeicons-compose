...
val HugeIcons.CallDone: ImageVector
    get() {
        if (_callDone != null) {
            return _callDone!!
        }
        _callDone = ImageVector.Builder(
            name = "CallDone",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(13f, 9f)
        curveTo(13f, 9f, 14.1429f, 9f, 15.2857f, 11f)
        curveTo(15.2857f, 11f, 17.7731f, 6f, 21f, 5f)
        }
        }.build()
...
private var _callDone: ImageVector? = null
