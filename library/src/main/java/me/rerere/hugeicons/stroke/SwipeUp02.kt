...
val HugeIcons.SwipeUp02: ImageVector
    get() {
        if (_swipeUp02 != null) {
            return _swipeUp02!!
        }
        _swipeUp02 = ImageVector.Builder(
            name = "SwipeUp02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(18.5f, 2.00195f)
        verticalLineTo(8.00195f)
        moveTo(18.5f, 2.00195f)
        curveTo(17.7998f, 2.00195f, 16.4915f, 3.99625f, 16f, 4.50195f)
        moveTo(18.5f, 2.00195f)
        curveTo(19.2002f, 2.00195f, 20.5085f, 3.99625f, 21f, 4.50195f)
        }
...
private var _swipeUp02: ImageVector? = null
