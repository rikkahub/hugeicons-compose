...
val HugeIcons.BubbleChatTranslate: ImageVector
    get() {
        if (_bubbleChatTranslate != null) {
            return _bubbleChatTranslate!!
        }
        _bubbleChatTranslate = ImageVector.Builder(
        ...
        moveTo(9f, 16.5f)
        curveTo(11.7116f, 14.6923f, 13.8451f, 12.2747f, 14.5f, 9f)
        moveTo(13.5f, 15f)
        curveTo(11.8882f, 13.7106f, 11.0341f, 12.3345f, 10.6761f, 11.5f)
        }
        }.build()
...
private var _bubbleChatTranslate: ImageVector? = null
