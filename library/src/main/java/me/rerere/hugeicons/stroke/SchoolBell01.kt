...
val HugeIcons.SchoolBell01: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(21.5f, 12.5f)
            arcTo(2.5f, 2.5f, 0f, true, false, 16.5f, 12.5f)
            arcTo(2.5f, 2.5f, 0f, true, false, 21.5f, 12.5f)
            close()
        }
        ...
        path(
            ...
            moveTo(12.5f, 10f)
            arcTo(2f, 2f, 0f, true, false, 8.5f, 10f)
            arcTo(2f, 2f, 0f, true, false, 12.5f, 10f)
            close()
        }
        }.build()
