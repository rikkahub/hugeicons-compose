...
val HugeIcons.KeyframesMultipleRemove: ImageVector
    get() {
        if (_keyframesMultipleRemove != null) {
            return _keyframesMultipleRemove!!
        }
        _keyframesMultipleRemove = ImageVector.Builder(
...
private var _keyframesMultipleRemove: ImageVector? = null
