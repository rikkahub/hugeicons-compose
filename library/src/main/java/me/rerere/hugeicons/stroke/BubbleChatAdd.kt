...
val HugeIcons.BubbleChatAdd: ImageVector
    get() {
        if (_bubbleChatAdd != null) {
            return _bubbleChatAdd!!
        }
        _bubbleChatAdd = ImageVector.Builder(
            name = "BubbleChatAdd",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _bubbleChatAdd: ImageVector? = null
