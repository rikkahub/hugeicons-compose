...
val HugeIcons.SubnodeDelete: ImageVector
    get() {
        if (_subnodeDelete != null) {
            return _subnodeDelete!!
        }
        _subnodeDelete = ImageVector.Builder(
            name = "SubnodeDelete",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _subnodeDelete: ImageVector? = null
