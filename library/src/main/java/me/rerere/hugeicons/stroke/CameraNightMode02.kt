...
val HugeIcons.CameraNightMode02: ImageVector
    get() {
        if (_cameraNightMode02 != null) {
            return _cameraNightMode02!!
        }
        _cameraNightMode02 = ImageVector.Builder(
        ...
        path(
            ...
            moveTo(12.8311f, 11.0066f)
            curveTo(12.8311f, 10.4694f, 12.9478f, 9.95964f, 13.1556f, 9.5f)
            curveTo(11.8848f, 10.0746f, 10.9999f, 11.3523f, 10.9999f, 12.8377f)
            curveTo(10.9999f, 14.8603f, 12.6396f, 16.5f, 14.6622f, 16.5f)
            curveTo(16.1476f, 16.5f, 17.4254f, 15.6152f, 17.9999f, 14.3443f)
            curveTo(17.5403f, 14.5521f, 17.0306f, 14.6689f, 16.4934f, 14.6689f)
            curveTo(14.4707f, 14.6689f, 12.8311f, 13.0292f, 12.8311f, 11.0066f)
            close()
        }
        }.build()
...
private var _cameraNightMode02: ImageVector? = null
