...
val HugeIcons.PhoneOutgoing: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(19.2592f, 4.73304f)
            lineTo(13.9922f, 10f)
            moveTo(14.9922f, 4.29599f)
            curveTo(16.2475f, 4.18677f, 19.0391f, 3.67736f, 19.6769f, 4.31524f)
            curveTo(20.3148f, 4.95312f, 19.8054f, 7.74466f, 19.6962f, 9f)
        }
        }.build()
