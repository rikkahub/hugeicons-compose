...
val HugeIcons.AiInnovation03: ImageVector
    get() {
        if (_aiInnovation03 != null) {
            return _aiInnovation03!!
        }
        _aiInnovation03 = ImageVector.Builder(
            name = "AiInnovation03",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        lineTo(10.5f, 16f)
        moveTo(8.25f, 10.5f)
        curveTo(8.66421f, 10.5f, 9f, 10.1642f, 9f, 9.75f)
        curveTo(9f, 9.33579f, 8.66421f, 9f, 8.25f, 9f)
        curveTo(7.83579f, 9f, 7.5f, 9.33579f, 7.5f, 9.75f)
        curveTo(7.5f, 10.1642f, 7.83579f, 10.5f, 8.25f, 10.5f)
        }
        ...
        lineTo(13.5f, 16f)
        moveTo(15.75f, 10.5f)
        curveTo(15.3358f, 10.5f, 15f, 10.1642f, 15f, 9.75f)
        curveTo(15f, 9.33579f, 15.3358f, 9f, 15.75f, 9f)
        curveTo(16.1642f, 9f, 16.5f, 9.33579f, 16.5f, 9.75f)
        curveTo(16.5f, 10.1642f, 16.1642f, 10.5f, 15.75f, 10.5f)
        }
        }.build()
...
private var _aiInnovation03: ImageVector? = null
