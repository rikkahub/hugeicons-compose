...
val HugeIcons.MailOpenLove: ImageVector
    get() {
        if (_mailOpenLove != null) {
            return _mailOpenLove!!
        }
        _mailOpenLove = ImageVector.Builder(
            name = "MailOpenLove",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            moveTo(9.76122f, 6.27615f)
            curveTo(10.5657f, 5.81923f, 11.2679f, 6.00336f, 11.6897f, 6.29667f)
            curveTo(11.8626f, 6.41693f, 11.9491f, 6.47706f, 12f, 6.47706f)
            curveTo(12.0509f, 6.47706f, 12.1373f, 6.41693f, 12.3103f, 6.29667f)
            curveTo(12.7321f, 6.00336f, 13.4343f, 5.81923f, 14.2388f, 6.27615f)
            curveTo(15.2946f, 6.87582f, 15.5335f, 8.85412f, 13.0981f, 10.5232f)
            curveTo(12.6343f, 10.8411f, 12.4023f, 11f, 12f, 11f)
            curveTo(11.5976f, 11f, 11.3657f, 10.8411f, 10.9018f, 10.5232f)
            curveTo(8.4665f, 8.85412f, 8.70541f, 6.87582f, 9.76122f, 6.27615f)
            close()
        }
        }.build()
...
private var _mailOpenLove: ImageVector? = null
