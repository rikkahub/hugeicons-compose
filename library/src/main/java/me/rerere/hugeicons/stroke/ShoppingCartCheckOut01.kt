...
val HugeIcons.ShoppingCartCheckOut01: ImageVector
    get() {
        if (_shoppingCartCheckOut01 != null) {
            return _shoppingCartCheckOut01!!
        }
        _shoppingCartCheckOut01 = ImageVector.Builder(
        ...
        curveTo(15.8373f, 17f, 16.9129f, 16.9939f, 17.7646f, 16.7355f)
        curveTo(19.6822f, 16.1538f, 21.1828f, 14.6532f, 21.7645f, 12.7356f)
        curveTo(21.9077f, 12.2634f, 21.9716f, 11.7312f, 22f, 10.9939f)
        moveTo(13.5f, 6f)
        ...
        moveTo(22f, 5.49998f)
        curveTo(22f, 5.49998f, 20.1588f, 3.00001f, 19.5f, 3f)
        curveTo(18.8412f, 2.99999f, 17f, 5.5f, 17f, 5.5f)
        moveTo(19.5f, 4f)
        lineTo(19.5f, 9f)
        }
        }.build()
...
private var _shoppingCartCheckOut01: ImageVector? = null
