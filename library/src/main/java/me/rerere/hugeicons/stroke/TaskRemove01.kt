...
val HugeIcons.TaskRemove01: ImageVector
    get() {
        if (_taskRemove01 != null) {
            return _taskRemove01!!
        }
        _taskRemove01 = ImageVector.Builder(
            name = "TaskRemove01",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(20.998f, 17f)
        lineTo(18.498f, 19.5f)
        moveTo(18.498f, 19.5f)
        lineTo(15.998f, 22f)
        moveTo(18.498f, 19.5f)
        lineTo(20.998f, 22f)
        moveTo(18.498f, 19.5f)
...
private var _taskRemove01: ImageVector? = null
