...
val HugeIcons.Triangle03: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(17.470480000000002f, 8.01465f)
            arcTo(1.38268f, 1.375f, 0f, true, false, 14.70512f, 8.01465f)
            arcTo(1.38268f, 1.375f, 0f, true, false, 17.470480000000002f, 8.01465f)
            close()
        }
        }.build()
