...
val HugeIcons.SunCloudMidSnow01: ImageVector
    get() {
        if (_sunCloudMidSnow01 != null) {
            return _sunCloudMidSnow01!!
        }
        _sunCloudMidSnow01 = ImageVector.Builder(
        ...
        verticalLineTo(20f)
        moveTo(14.5f, 15.5f)
        lineTo(9.50013f, 18.5f)
        moveTo(9.5f, 15.5f)
        lineTo(14.4999f, 18.5f)
        }
        }.build()
...
private var _sunCloudMidSnow01: ImageVector? = null
