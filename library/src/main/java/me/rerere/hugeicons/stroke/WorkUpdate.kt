...
val HugeIcons.WorkUpdate: ImageVector
    get() {
        if (_workUpdate != null) {
            return _workUpdate!!
        }
        _workUpdate = ImageVector.Builder(
            name = "WorkUpdate",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        curveTo(22f, 15.0147f, 19.9853f, 13f, 17.5f, 13f)
        curveTo(15.0147f, 13f, 13f, 15.0147f, 13f, 17.5f)
        curveTo(13f, 19.9853f, 15.0147f, 22f, 17.5f, 22f)
        }
        ...
        moveTo(19.5f, 18f)
        lineTo(18.9142f, 18.5541f)
        curveTo(18.2475f, 19.1847f, 17.9142f, 19.5f, 17.5f, 19.5f)
        moveTo(15.5f, 18f)
        lineTo(16.0858f, 18.5541f)
        curveTo(16.7525f, 19.1847f, 17.0858f, 19.5f, 17.5f, 19.5f)
        moveTo(17.5f, 19.5f)
...
private var _workUpdate: ImageVector? = null
