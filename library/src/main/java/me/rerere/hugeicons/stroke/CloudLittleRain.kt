...
val HugeIcons.CloudLittleRain: ImageVector
    get() {
        if (_cloudLittleRain != null) {
            return _cloudLittleRain!!
        }
        _cloudLittleRain = ImageVector.Builder(
...
private var _cloudLittleRain: ImageVector? = null
