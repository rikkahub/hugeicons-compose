...
val HugeIcons.CalendarUpload02: ImageVector
    get() {
        if (_calendarUpload02 != null) {
            return _calendarUpload02!!
        }
        _calendarUpload02 = ImageVector.Builder(
        ...
        moveTo(9.5f, 15.4984f)
        curveTo(9.99153f, 14.9927f, 11.2998f, 12.9984f, 12f, 12.9984f)
        curveTo(12.7002f, 12.9984f, 14.0085f, 14.9927f, 14.5f, 15.4984f)
        moveTo(12f, 13.4984f)
        verticalLineTo(18.9984f)
        }
        }.build()
...
private var _calendarUpload02: ImageVector? = null
