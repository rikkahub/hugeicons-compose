...
val HugeIcons.SummationSquare: ImageVector
    get() {
        if (_summationSquare != null) {
            return _summationSquare!!
        }
        _summationSquare = ImageVector.Builder(
            name = "SummationSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _summationSquare: ImageVector? = null
