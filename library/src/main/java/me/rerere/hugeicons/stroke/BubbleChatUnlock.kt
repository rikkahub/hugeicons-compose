...
val HugeIcons.BubbleChatUnlock: ImageVector
    get() {
        if (_bubbleChatUnlock != null) {
            return _bubbleChatUnlock!!
        }
        _bubbleChatUnlock = ImageVector.Builder(
        ...
        curveTo(12.5523f, 7.5f, 13.0523f, 7.72386f, 13.4142f, 8.08579f)
        }
...
private var _bubbleChatUnlock: ImageVector? = null
