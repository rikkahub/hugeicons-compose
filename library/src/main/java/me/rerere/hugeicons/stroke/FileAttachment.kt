...
val HugeIcons.FileAttachment: ImageVector
    get() {
        if (_fileAttachment != null) {
            return _fileAttachment!!
        }
        _fileAttachment = ImageVector.Builder(
            name = "FileAttachment",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(4f, 8.23028f)
        verticalLineTo(5.46105f)
        curveTo(4f, 3.54929f, 5.567f, 1.99951f, 7.5f, 1.99951f)
        curveTo(9.433f, 1.99951f, 11f, 3.54929f, 11f, 5.46105f)
        verticalLineTo(9.26874f)
        curveTo(11f, 10.2246f, 10.2165f, 10.9995f, 9.25f, 10.9995f)
        curveTo(8.2835f, 10.9995f, 7.5f, 10.2246f, 7.5f, 9.26874f)
        verticalLineTo(5.46105f)
        }
        }.build()
...
private var _fileAttachment: ImageVector? = null
