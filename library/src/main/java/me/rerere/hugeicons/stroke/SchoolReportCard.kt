...
val HugeIcons.SchoolReportCard: ImageVector
    get() {
        if (_schoolReportCard != null) {
            return _schoolReportCard!!
        }
        _schoolReportCard = ImageVector.Builder(
        ...
        lineTo(9.85714f, 11f)
        moveTo(9.85714f, 11f)
        lineTo(11.4076f, 7.38235f)
        curveTo(11.5067f, 7.15092f, 11.7406f, 7f, 12f, 7f)
        curveTo(12.2594f, 7f, 12.4933f, 7.15092f, 12.5924f, 7.38235f)
        lineTo(14.1429f, 11f)
        moveTo(9.85714f, 11f)
        horizontalLineTo(14.1429f)
        }
...
private var _schoolReportCard: ImageVector? = null
