...
val HugeIcons.FolderExport: ImageVector
    get() {
        if (_folderExport != null) {
            return _folderExport!!
        }
        _folderExport = ImageVector.Builder(
            name = "FolderExport",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(19f, 21f)
        curveTo(19.6068f, 20.4102f, 22f, 18.8403f, 22f, 18f)
        curveTo(22f, 17.1597f, 19.6068f, 15.5898f, 19f, 15f)
        moveTo(21f, 18f)
...
private var _folderExport: ImageVector? = null
