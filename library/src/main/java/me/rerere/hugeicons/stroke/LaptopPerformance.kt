...
val HugeIcons.LaptopPerformance: ImageVector
    get() {
        if (_laptopPerformance != null) {
            return _laptopPerformance!!
        }
        _laptopPerformance = ImageVector.Builder(
        ...
        lineTo(10.9999f, 12.5f)
        lineTo(12.9999f, 7.5f)
        lineTo(14.4999f, 10f)
...
private var _laptopPerformance: ImageVector? = null
