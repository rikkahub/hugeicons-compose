...
val HugeIcons.RssUnlocked: ImageVector
    get() {
        if (_rssUnlocked != null) {
            return _rssUnlocked!!
        }
        _rssUnlocked = ImageVector.Builder(
            name = "RssUnlocked",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            curveTo(17.5973f, 3f, 18.1335f, 3.26188f, 18.5f, 3.67709f)
        }
...
private var _rssUnlocked: ImageVector? = null
