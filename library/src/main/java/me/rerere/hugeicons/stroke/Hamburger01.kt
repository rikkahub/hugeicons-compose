...
val HugeIcons.Hamburger01: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(15.25f, 7f)
            curveTo(15.25f, 7.13807f, 15.1381f, 7.25f, 15f, 7.25f)
            curveTo(14.8619f, 7.25f, 14.75f, 7.13807f, 14.75f, 7f)
            curveTo(14.75f, 6.86193f, 14.8619f, 6.75f, 15f, 6.75f)
            curveTo(15.1381f, 6.75f, 15.25f, 6.86193f, 15.25f, 7f)
            close()
        }
        }.build()
