...
val HugeIcons.SwipeLeft04: ImageVector
    get() {
        if (_swipeLeft04 != null) {
            return _swipeLeft04!!
        }
        _swipeLeft04 = ImageVector.Builder(
            name = "SwipeLeft04",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        lineTo(20.5f, 4.5f)
        moveTo(14.5f, 4.5f)
        curveTo(14.5f, 3.79977f, 16.4943f, 2.49153f, 17f, 2f)
        moveTo(14.5f, 4.5f)
        curveTo(14.5f, 5.20023f, 16.4943f, 6.50847f, 17f, 7f)
        }
        }.build()
...
private var _swipeLeft04: ImageVector? = null
