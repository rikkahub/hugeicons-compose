...
val HugeIcons.BubbleChatUpload: ImageVector
    get() {
        if (_bubbleChatUpload != null) {
            return _bubbleChatUpload!!
        }
        _bubbleChatUpload = ImageVector.Builder(
        ...
        moveTo(15f, 11.5f)
        curveTo(15f, 11.5f, 12.7905f, 8.50003f, 12f, 8.50002f)
        curveTo(11.2094f, 8.50002f, 9f, 11.5f, 9f, 11.5f)
        moveTo(12f, 9.00002f)
...
private var _bubbleChatUpload: ImageVector? = null
