...
val HugeIcons.Medal07: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(17.5f, 16.5f)
            arcTo(5.5f, 5.5f, 0f, true, false, 6.5f, 16.5f)
            arcTo(5.5f, 5.5f, 0f, true, false, 17.5f, 16.5f)
            close()
        }
        ...
        path(
            ...
            moveTo(13.5f, 16.5f)
            arcTo(1.5f, 1.5f, 0f, true, false, 10.5f, 16.5f)
            arcTo(1.5f, 1.5f, 0f, true, false, 13.5f, 16.5f)
            close()
        }
        }.build()
