...
val HugeIcons.ImageDownload02: ImageVector
    get() {
        if (_imageDownload02 != null) {
            return _imageDownload02!!
        }
        _imageDownload02 = ImageVector.Builder(
        ...
        moveTo(21.5f, 6.5f)
        curveTo(20.9102f, 7.10684f, 19.3403f, 9.5f, 18.5f, 9.5f)
        curveTo(17.6597f, 9.5f, 16.0898f, 7.10684f, 15.5f, 6.5f)
        moveTo(18.5f, 9f)
        verticalLineTo(2.5f)
        }
        }.build()
...
private var _imageDownload02: ImageVector? = null
