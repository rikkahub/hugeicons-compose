...
val HugeIcons.LocationCheck02: ImageVector
    get() {
        if (_locationCheck02 != null) {
            return _locationCheck02!!
        }
        _locationCheck02 = ImageVector.Builder(
        ...
        moveTo(8.5f, 11.8333f)
        curveTo(8.5f, 11.8333f, 9.41602f, 11.8333f, 10.291f, 13.5f)
        curveTo(10.291f, 13.5f, 13.0294f, 9.33333f, 15.5f, 8.5f)
        }
        }.build()
...
private var _locationCheck02: ImageVector? = null
