...
val HugeIcons.ChatDone: ImageVector
    get() {
        if (_chatDone != null) {
            return _chatDone!!
        }
        _chatDone = ImageVector.Builder(
            name = "ChatDone",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(9f, 11.3333f)
        curveTo(9f, 11.3333f, 10f, 11.3333f, 11f, 13f)
        curveTo(11f, 13f, 13.1765f, 8.83333f, 16f, 8f)
        }
        }.build()
...
private var _chatDone: ImageVector? = null
