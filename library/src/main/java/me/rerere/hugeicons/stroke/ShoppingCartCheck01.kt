...
val HugeIcons.ShoppingCartCheck01: ImageVector
    get() {
        if (_shoppingCartCheck01 != null) {
            return _shoppingCartCheck01!!
        }
        _shoppingCartCheck01 = ImageVector.Builder(
        ...
        path(
            ...
            moveTo(15f, 7f)
            curveTo(15f, 7f, 16f, 7f, 17f, 9f)
            curveTo(17f, 9f, 19.1765f, 4f, 22f, 3f)
        }
        }.build()
...
private var _shoppingCartCheck01: ImageVector? = null
