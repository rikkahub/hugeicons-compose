...
val HugeIcons.CameraMicrophone02: ImageVector
    get() {
        if (_cameraMicrophone02 != null) {
            return _cameraMicrophone02!!
        }
        _cameraMicrophone02 = ImageVector.Builder(
            name = "CameraMicrophone02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
        ...
        path(
            ...
            moveTo(14.5001f, 16f)
            curveTo(15.8963f, 16f, 17.5f, 15f, 18f, 14f)
            moveTo(14.5001f, 16f)
            curveTo(13.1039f, 16f, 11.5002f, 15f, 11.0002f, 14f)
            moveTo(14.5001f, 16f)
            lineTo(14.5001f, 17.5f)
            moveTo(14.5001f, 13.5f)
            curveTo(13.6717f, 13.5f, 13.0001f, 12.8284f, 13.0001f, 12f)
            lineTo(13.0001f, 10f)
            curveTo(13.0001f, 9.17157f, 13.6717f, 8.5f, 14.5001f, 8.5f)
            curveTo(15.3285f, 8.5f, 16.0001f, 9.17157f, 16.0001f, 10f)
            verticalLineTo(12f)
            curveTo(16.0001f, 12.8284f, 15.3285f, 13.5f, 14.5001f, 13.5f)
            close()
        }
        }.build()
...
private var _cameraMicrophone02: ImageVector? = null
