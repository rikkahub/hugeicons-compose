...
val HugeIcons.FileBraces: ImageVector
    get() {
        if (_fileBraces != null) {
            return _fileBraces!!
        }
        ...
        path(
            ...
            moveTo(14f, 12f)
            curveTo(14.5523f, 12f, 15f, 12.4477f, 15f, 13f)
            verticalLineTo(14f)
            curveTo(15f, 14.5523f, 15.4477f, 15f, 16f, 15f)
            curveTo(15.4477f, 15f, 15f, 15.4477f, 15f, 16f)
            verticalLineTo(17f)
            curveTo(15f, 17.5523f, 14.5523f, 18f, 14f, 18f)
            moveTo(10f, 12f)
            curveTo(9.44772f, 12f, 9f, 12.4477f, 9f, 13f)
            verticalLineTo(14f)
            curveTo(9f, 14.5523f, 8.55228f, 15f, 8f, 15f)
            curveTo(8.55228f, 15f, 9f, 15.4477f, 9f, 16f)
            verticalLineTo(17f)
