...
val HugeIcons.Task01: ImageVector
    get() {
        ...
        curveTo(8.66767f, 2.00027f, 7.99609f, 2.67185f, 7.99609f, 3.50027f)
        curveTo(7.99609f, 4.3287f, 8.66767f, 5.00027f, 9.49609f, 5.00027f)
        ...
        curveTo(17.5496f, 3.54709f, 18.4761f, 3.72035f, 19.1174f, 4.36164f)
        ...
        lineTo(3.99611f, 9.48296f)
        curveTo(3.9961f, 6.65453f, 3.9961f, 5.24031f, 4.87478f, 4.36163f)
        curveTo(5.51606f, 3.72034f, 6.44261f, 3.54708f, 7.99599f, 3.50027f)
        }
        }.build()
