...
val HugeIcons.ChatUnlock: ImageVector
    get() {
        if (_chatUnlock != null) {
            return _chatUnlock!!
        }
        _chatUnlock = ImageVector.Builder(
            name = "ChatUnlock",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        curveTo(12.5523f, 6.5f, 13.0523f, 6.72386f, 13.4142f, 7.08579f)
        }
...
private var _chatUnlock: ImageVector? = null
