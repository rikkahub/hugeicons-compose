...
val HugeIcons.WashingMachine: ImageVector
    get() {
        ...
        path(
            ...
            horizontalLineTo(7f)
            moveTo(7.25f, 6f)
            curveTo(7.25f, 6.13807f, 7.13807f, 6.25f, 7f, 6.25f)
            curveTo(6.86193f, 6.25f, 6.75f, 6.13807f, 6.75f, 6f)
            curveTo(6.75f, 5.86193f, 6.86193f, 5.75f, 7f, 5.75f)
            curveTo(7.13807f, 5.75f, 7.25f, 5.86193f, 7.25f, 6f)
            close()
        }
        }.build()
