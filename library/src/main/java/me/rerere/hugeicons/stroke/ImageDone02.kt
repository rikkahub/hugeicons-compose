...
val HugeIcons.ImageDone02: ImageVector
    get() {
        if (_imageDone02 != null) {
            return _imageDone02!!
        }
        _imageDone02 = ImageVector.Builder(
            name = "ImageDone02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(14.5f, 6.03848f)
        curveTo(14.5f, 6.03848f, 16.1102f, 6.32521f, 17f, 8.50081f)
        curveTo(17f, 8.50081f, 18.6764f, 3.50081f, 21.5f, 2.50081f)
        }
        }.build()
...
private var _imageDone02: ImageVector? = null
