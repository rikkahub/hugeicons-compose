...
val HugeIcons.ChatUser: ImageVector
    get() {
        if (_chatUser != null) {
            return _chatUser!!
        }
        _chatUser = ImageVector.Builder(
            name = "ChatUser",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(8.5f, 13.9984f)
        curveTo(8.5f, 12.0654f, 10.067f, 10.4984f, 12f, 10.4984f)
        curveTo(13.933f, 10.4984f, 15.5f, 12.0654f, 15.5f, 13.9984f)
        moveTo(14f, 8.5f)
        curveTo(14f, 9.60457f, 13.1046f, 10.5f, 12f, 10.5f)
        curveTo(10.8954f, 10.5f, 10f, 9.60457f, 10f, 8.5f)
...
private var _chatUser: ImageVector? = null
