...
val HugeIcons.ChatPreview: ImageVector
    get() {
        if (_chatPreview != null) {
            return _chatPreview!!
        }
        _chatPreview = ImageVector.Builder(
            name = "ChatPreview",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            moveTo(17f, 10.5f)
            curveTo(17f, 10.5f, 14.958f, 13.5f, 12f, 13.5f)
            curveTo(9.04197f, 13.5f, 7f, 10.5f, 7f, 10.5f)
            curveTo(7f, 10.5f, 9f, 7.5f, 12f, 7.5f)
            curveTo(15f, 7.5f, 17f, 10.5f, 17f, 10.5f)
            close()
        }
        ...
        path(
            ...
            moveTo(12.125f, 10.5f)
            horizontalLineTo(12f)
            moveTo(12.25f, 10.5f)
            curveTo(12.25f, 10.6381f, 12.1381f, 10.75f, 12f, 10.75f)
            curveTo(11.8619f, 10.75f, 11.75f, 10.6381f, 11.75f, 10.5f)
            curveTo(11.75f, 10.3619f, 11.8619f, 10.25f, 12f, 10.25f)
            curveTo(12.1381f, 10.25f, 12.25f, 10.3619f, 12.25f, 10.5f)
            close()
        }
        }.build()
...
private var _chatPreview: ImageVector? = null
