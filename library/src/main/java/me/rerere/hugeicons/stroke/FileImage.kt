...
val HugeIcons.FileImage: ImageVector
    get() {
        if (_fileImage != null) {
            return _fileImage!!
        }
        ...
        path(
            ...
            moveTo(11f, 12.5f)
            arcTo(1.5f, 1.5f, 0f, true, false, 8f, 12.5f)
            arcTo(1.5f, 1.5f, 0f, true, false, 11f, 12.5f)
            close()
        }
        ...
        path(
            ...
            moveTo(7.5f, 21.5f)
            lineTo(14.2929f, 14.7071f)
            curveTo(14.7456f, 14.2544f, 15.3597f, 14f, 16f, 14f)
            curveTo(16.6403f, 14f, 17.2544f, 14.2544f, 17.7071f, 14.7071f)
            lineTo(19.8138f, 16.8138f)
        }
