...
val HugeIcons.MapPinMinus: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(12.4531f, 21.0625f)
            curveTo(12.2202f, 21.354f, 11.8603f, 21.5f, 11.5f, 21.5f)
            ...
            curveTo(19.5f, 11.6168f, 19.3183f, 12.596f, 18.9549f, 13.5f)
        }
