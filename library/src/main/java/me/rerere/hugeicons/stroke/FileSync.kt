...
val HugeIcons.FileSync: ImageVector
    get() {
        if (_fileSync != null) {
            return _fileSync!!
        }
        ...
        moveTo(11f, 16f)
        lineTo(12f, 18f)
        curveTo(12.2426f, 16.3039f, 13.7368f, 15f, 15.5f, 15f)
        curveTo(16.6894f, 15f, 17.7402f, 15.5933f, 18.3726f, 16.5f)
        moveTo(20f, 21f)
        lineTo(19f, 19f)
        curveTo(18.7574f, 20.6961f, 17.2632f, 22f, 15.5f, 22f)
        curveTo(14.3106f, 22f, 13.2598f, 21.4067f, 12.6273f, 20.5f)
        }
        }.build()
