...
val HugeIcons.Ethereum: ImageVector
    get() {
        ...
        lineTo(5.91655f, 10.0635f)
        curveTo(5.30547f, 10.9997f, 4.99992f, 11.4677f, 4.99992f, 11.9999f)
        moveTo(18.9999f, 11.9999f)
        ...
        curveTo(11.1802f, 21.9999f, 10.5935f, 21.1012f, 9.42025f, 19.3038f)
        lineTo(5.91655f, 13.9364f)
        curveTo(5.30547f, 13.0002f, 4.99992f, 12.5322f, 4.99992f, 11.9999f)
        }
        }.build()
