...
val HugeIcons.UserUnlock02: ImageVector
    get() {
        if (_userUnlock02 != null) {
            return _userUnlock02!!
        }
        _userUnlock02 = ImageVector.Builder(
            name = "UserUnlock02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            moveTo(17.75f, 8f)
            verticalLineTo(6.5f)
            curveTo(17.75f, 5.67157f, 18.4216f, 5f, 19.25f, 5f)
            curveTo(19.6642f, 5f, 20.0392f, 5.16789f, 20.3107f, 5.43934f)
            moveTo(17.75f, 8f)
...
private var _userUnlock02: ImageVector? = null
