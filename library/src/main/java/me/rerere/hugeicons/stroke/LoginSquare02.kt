...
val HugeIcons.LoginSquare02: ImageVector
    get() {
        ...
        curveTo(18.9701f, 3.75965f, 18.7844f, 3.57394f, 18.5818f, 3.40772f)
        curveTo(17.4755f, 2.49976f, 15.8318f, 2.49976f, 12.5443f, 2.49976f)
        lineTo(11.9999f, 2.49992f)
        curveTo(8.2287f, 2.49992f, 6.34308f, 2.49992f, 5.17151f, 3.67149f)
        curveTo(3.99994f, 4.84307f, 3.99994f, 6.72868f, 3.99994f, 10.4999f)
        verticalLineTo(13.4999f)
        curveTo(3.99994f, 17.2712f, 3.99994f, 19.1568f, 5.17151f, 20.3283f)
        curveTo(6.34308f, 21.4999f, 8.2287f, 21.4999f, 11.9999f, 21.4999f)
        lineTo(12.5443f, 21.4998f)
        curveTo(15.8318f, 21.4998f, 17.4755f, 21.4998f, 18.5818f, 20.5918f)
