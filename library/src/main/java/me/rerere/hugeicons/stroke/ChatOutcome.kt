...
val HugeIcons.ChatOutcome: ImageVector
    get() {
        if (_chatOutcome != null) {
            return _chatOutcome!!
        }
        _chatOutcome = ImageVector.Builder(
            name = "ChatOutcome",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(12.5f, 7.5f)
        curveTo(12.5f, 7.5f, 15.5f, 9.70947f, 15.5f, 10.5f)
        curveTo(15.5f, 11.2906f, 12.5f, 13.5f, 12.5f, 13.5f)
        moveTo(15f, 10.5f)
        lineTo(8.5f, 10.5f)
        }
        }.build()
...
private var _chatOutcome: ImageVector? = null
