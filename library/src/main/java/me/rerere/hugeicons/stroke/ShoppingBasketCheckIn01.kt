...
val HugeIcons.ShoppingBasketCheckIn01: ImageVector
    get() {
        if (_shoppingBasketCheckIn01 != null) {
            return _shoppingBasketCheckIn01!!
        }
        _shoppingBasketCheckIn01 = ImageVector.Builder(
        ...
        moveTo(21f, 18f)
        curveTo(21f, 18f, 18.7905f, 15f, 18f, 15f)
        curveTo(17.2094f, 15f, 15f, 18f, 15f, 18f)
        moveTo(18f, 15.5f)
        verticalLineTo(22f)
        }
        }.build()
...
private var _shoppingBasketCheckIn01: ImageVector? = null
