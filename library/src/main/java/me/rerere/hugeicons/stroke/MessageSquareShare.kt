...
val HugeIcons.MessageSquareShare: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(21.6681f, 8.5f)
            curveTo(21.6681f, 8.5f, 22.4149f, 3.57875f, 21.6681f, 2.83192f)
            curveTo(20.9213f, 2.08509f, 16f, 2.83194f, 16f, 2.83194f)
            moveTo(21f, 3.5f)
            lineTo(16f, 8.5f)
        }
