...
val HugeIcons.BadgePoundSterling: ImageVector
    get() {
        ...
        path(
            ...
            curveTo(9.60457f, 16f, 10.5f, 15.1046f, 10.5f, 14f)
            lineTo(10.5f, 9.5f)
            curveTo(10.5f, 8.39543f, 11.3954f, 7.5f, 12.5f, 7.5f)
            curveTo(13.6046f, 7.5f, 14.5f, 8.39543f, 14.5f, 9.5f)
            moveTo(8.5f, 12f)
