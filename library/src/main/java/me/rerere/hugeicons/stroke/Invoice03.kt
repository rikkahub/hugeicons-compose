...
val HugeIcons.Invoice03: ImageVector
    get() {
        if (_invoice03 != null) {
            return _invoice03!!
        }
        _invoice03 = ImageVector.Builder(
            name = "Invoice03",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(12.5f, 10.875f)
        curveTo(11.6716f, 10.875f, 11f, 11.4626f, 11f, 12.1875f)
        curveTo(11f, 12.9124f, 11.6716f, 13.5f, 12.5f, 13.5f)
        curveTo(13.3284f, 13.5f, 14f, 14.0876f, 14f, 14.8125f)
        curveTo(14f, 15.5374f, 13.3284f, 16.125f, 12.5f, 16.125f)
        moveTo(12.5f, 10.875f)
        curveTo(13.1531f, 10.875f, 13.7087f, 11.2402f, 13.9146f, 11.75f)
        moveTo(12.5f, 10.875f)
        verticalLineTo(10f)
        moveTo(12.5f, 16.125f)
        curveTo(11.8469f, 16.125f, 11.2913f, 15.7598f, 11.0854f, 15.25f)
        moveTo(12.5f, 16.125f)
        verticalLineTo(17f)
        }
        }.build()
...
private var _invoice03: ImageVector? = null
