...
val HugeIcons.Activity02: ImageVector
    get() {
        if (_activity02 != null) {
            return _activity02!!
        }
        _activity02 = ImageVector.Builder(
            name = "Activity02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(6.5f, 14.5f)
        lineTo(9.29289f, 11.7071f)
        curveTo(9.68342f, 11.3166f, 10.3166f, 11.3166f, 10.7071f, 11.7071f)
...
private var _activity02: ImageVector? = null
