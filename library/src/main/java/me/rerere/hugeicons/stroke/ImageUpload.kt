...
val HugeIcons.ImageUpload: ImageVector
    get() {
        if (_imageUpload != null) {
            return _imageUpload!!
        }
        _imageUpload = ImageVector.Builder(
            name = "ImageUpload",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(15.5f, 5.5f)
        curveTo(16.0898f, 4.89316f, 17.6597f, 2.5f, 18.5f, 2.5f)
        curveTo(19.3403f, 2.5f, 20.9102f, 4.89316f, 21.5f, 5.5f)
        moveTo(18.5f, 3f)
        verticalLineTo(9.5f)
        }
        }.build()
...
private var _imageUpload: ImageVector? = null
