...
val HugeIcons.Chat: ImageVector
    get() {
        if (_chat != null) {
            return _chat!!
        }
        ...
        path(
            ...
            moveTo(12.1257f, 10.5f)
            horizontalLineTo(12.0007f)
            moveTo(8.125f, 10.5f)
            horizontalLineTo(8f)
            moveTo(16.125f, 10.5f)
            horizontalLineTo(16f)
            moveTo(12.2507f, 10.5f)
            curveTo(12.2507f, 10.6381f, 12.1388f, 10.75f, 12.0007f, 10.75f)
            curveTo(11.8627f, 10.75f, 11.7507f, 10.6381f, 11.7507f, 10.5f)
            curveTo(11.7507f, 10.3619f, 11.8627f, 10.25f, 12.0007f, 10.25f)
            curveTo(12.1388f, 10.25f, 12.2507f, 10.3619f, 12.2507f, 10.5f)
            close()
            moveTo(8.25f, 10.5f)
            curveTo(8.25f, 10.6381f, 8.13807f, 10.75f, 8f, 10.75f)
            curveTo(7.86193f, 10.75f, 7.75f, 10.6381f, 7.75f, 10.5f)
            curveTo(7.75f, 10.3619f, 7.86193f, 10.25f, 8f, 10.25f)
            curveTo(8.13807f, 10.25f, 8.25f, 10.3619f, 8.25f, 10.5f)
            close()
            moveTo(16.25f, 10.5f)
            curveTo(16.25f, 10.6381f, 16.1381f, 10.75f, 16f, 10.75f)
            curveTo(15.8619f, 10.75f, 15.75f, 10.6381f, 15.75f, 10.5f)
            curveTo(15.75f, 10.3619f, 15.8619f, 10.25f, 16f, 10.25f)
            curveTo(16.1381f, 10.25f, 16.25f, 10.3619f, 16.25f, 10.5f)
            close()
        }
        }.build()
