...
val HugeIcons.Ppt01: ImageVector
    get() {
        if (_ppt01 != null) {
            return _ppt01!!
        }
        _ppt01 = ImageVector.Builder(
            name = "Ppt01",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        curveTo(12.8284f, 16f, 13.5f, 16.6716f, 13.5f, 17.5f)
        curveTo(13.5f, 18.3284f, 12.8284f, 19f, 12f, 19f)
...
private var _ppt01: ImageVector? = null
