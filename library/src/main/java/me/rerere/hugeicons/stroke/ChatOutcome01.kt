...
val HugeIcons.ChatOutcome01: ImageVector
    get() {
        if (_chatOutcome01 != null) {
            return _chatOutcome01!!
        }
        _chatOutcome01 = ImageVector.Builder(
            name = "ChatOutcome01",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            curveTo(22f, 10.6629f, 21.9974f, 10.3294f, 21.9924f, 10f)
        }
        ...
        path(
            ...
            moveTo(19f, 2f)
            curveTo(19f, 2f, 22f, 4.20947f, 22f, 5.00002f)
            curveTo(22f, 5.79058f, 19f, 8f, 19f, 8f)
            moveTo(21.5f, 5.00002f)
            lineTo(15f, 5.00002f)
        }
...
private var _chatOutcome01: ImageVector? = null
