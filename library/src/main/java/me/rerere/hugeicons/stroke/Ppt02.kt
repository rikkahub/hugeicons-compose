...
val HugeIcons.Ppt02: ImageVector
    get() {
        if (_ppt02 != null) {
            return _ppt02!!
        }
        _ppt02 = ImageVector.Builder(
            name = "Ppt02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        verticalLineTo(14f)
        lineTo(13.5f, 14f)
        curveTo(14.3284f, 14f, 15f, 14.6716f, 15f, 15.5f)
        curveTo(15f, 16.3284f, 14.3284f, 17f, 13.5f, 17f)
...
private var _ppt02: ImageVector? = null
