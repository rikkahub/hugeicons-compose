...
val HugeIcons.ArrangeByLettersZA: ImageVector
    get() {
        if (_arrangeByLettersZA != null) {
            return _arrangeByLettersZA!!
        }
        _arrangeByLettersZA = ImageVector.Builder(
...
private var _arrangeByLettersZA: ImageVector? = null
