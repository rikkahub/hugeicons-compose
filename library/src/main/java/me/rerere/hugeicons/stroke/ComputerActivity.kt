...
val HugeIcons.ComputerActivity: ImageVector
    get() {
        if (_computerActivity != null) {
            return _computerActivity!!
        }
        _computerActivity = ImageVector.Builder(
            name = "ComputerActivity",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _computerActivity: ImageVector? = null
