...
val HugeIcons.LaptopCheck: ImageVector
    get() {
        ...
        moveTo(9.49988f, 10.4f)
        curveTo(9.49988f, 10.4f, 10.357f, 10.8f, 10.9999f, 12f)
        curveTo(10.9999f, 12f, 13.3822f, 8.66667f, 15.4999f, 8f)
        }
        }.build()
