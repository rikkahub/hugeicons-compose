...
val HugeIcons.Location01: ImageVector
    get() {
        if (_location01 != null) {
            return _location01!!
        }
        _location01 = ImageVector.Builder(
            name = "Location01",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(15.5f, 11f)
        curveTo(15.5f, 12.933f, 13.933f, 14.5f, 12f, 14.5f)
        curveTo(10.067f, 14.5f, 8.5f, 12.933f, 8.5f, 11f)
        curveTo(8.5f, 9.067f, 10.067f, 7.5f, 12f, 7.5f)
...
private var _location01: ImageVector? = null
