...
val HugeIcons.MoneyNotFound01: ImageVector
    get() {
        if (_moneyNotFound01 != null) {
            return _moneyNotFound01!!
        }
        _moneyNotFound01 = ImageVector.Builder(
        ...
        path(
            ...
            moveTo(2.01733f, 9.00001f)
            curveTo(3.87717f, 9.00001f, 5.43925f, 7.72519f, 5.87743f, 6.00171f)
        }
        ...
        path(
            ...
            moveTo(21.8907f, 15f)
            curveTo(21.0718f, 15f, 20.312f, 15.253f, 19.6851f, 15.6851f)
        }
...
private var _moneyNotFound01: ImageVector? = null
