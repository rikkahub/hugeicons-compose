...
val HugeIcons.ChatIncome: ImageVector
    get() {
        if (_chatIncome != null) {
            return _chatIncome!!
        }
        _chatIncome = ImageVector.Builder(
            name = "ChatIncome",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(11.5f, 7.49998f)
        curveTo(11.5f, 7.49998f, 8.50001f, 9.70944f, 8.5f, 10.5f)
        curveTo(8.49999f, 11.2906f, 11.5f, 13.5f, 11.5f, 13.5f)
        moveTo(9f, 10.5f)
        lineTo(15.5f, 10.5f)
        }
        }.build()
...
private var _chatIncome: ImageVector? = null
