...
val HugeIcons.FileTypeCorner: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(11f, 15f)
            curveTo(11f, 14.4477f, 10.5523f, 14f, 10f, 14f)
            horizontalLineTo(4f)
            curveTo(3.44772f, 14f, 3f, 14.4477f, 3f, 15f)
        }
        ...
        path(
            ...
            moveTo(13.0345f, 21.999f)
            curveTo(16.1265f, 21.9892f, 17.7693f, 21.8876f, 18.8284f, 20.8284f)
