...
val HugeIcons.ChatFavourite: ImageVector
    get() {
        if (_chatFavourite != null) {
            return _chatFavourite!!
        }
        _chatFavourite = ImageVector.Builder(
            name = "ChatFavourite",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(12f, 14.5f)
        curveTo(12f, 14.5f, 8f, 12.0294f, 8f, 9.63889f)
        curveTo(8f, 8.45761f, 8.84211f, 7.5f, 10f, 7.5f)
        curveTo(10.6f, 7.5f, 11.2f, 7.70588f, 12f, 8.52941f)
        curveTo(12.8f, 7.70588f, 13.4f, 7.5f, 14f, 7.5f)
        curveTo(15.1579f, 7.5f, 16f, 8.45761f, 16f, 9.63889f)
        curveTo(16f, 12.0294f, 12f, 14.5f, 12f, 14.5f)
        }
        }.build()
...
private var _chatFavourite: ImageVector? = null
