...
val HugeIcons.BubbleChatDelay: ImageVector
    get() {
        if (_bubbleChatDelay != null) {
            return _bubbleChatDelay!!
        }
        _bubbleChatDelay = ImageVector.Builder(
...
private var _bubbleChatDelay: ImageVector? = null
