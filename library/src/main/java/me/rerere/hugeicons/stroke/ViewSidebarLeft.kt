...
val HugeIcons.ViewSidebarLeft: ImageVector
    get() {
        if (_viewSidebarLeft != null) {
            return _viewSidebarLeft!!
        }
        _viewSidebarLeft = ImageVector.Builder(
            name = "ViewSidebarLeft",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _viewSidebarLeft: ImageVector? = null
