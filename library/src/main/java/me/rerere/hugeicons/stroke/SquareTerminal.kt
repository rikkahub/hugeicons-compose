...
val HugeIcons.SquareTerminal: ImageVector
    get() {
        ...
        path(
            ...
            lineTo(8.71873f, 8.55719f)
            curveTo(9.23437f, 9.00163f, 9.49219f, 9.22386f, 9.49219f, 9.5f)
            curveTo(9.49219f, 9.77614f, 9.23437f, 9.99836f, 8.71873f, 10.4428f)
            lineTo(7.49219f, 11.5f)
        }
