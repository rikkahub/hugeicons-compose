...
val HugeIcons.SafetyPin01: ImageVector
    get() {
        if (_safetyPin01 != null) {
            return _safetyPin01!!
        }
        _safetyPin01 = ImageVector.Builder(
            name = "SafetyPin01",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            moveTo(7f, 19.5f)
            arcTo(2.5f, 2.5f, 0f, true, false, 2f, 19.5f)
            arcTo(2.5f, 2.5f, 0f, true, false, 7f, 19.5f)
            close()
        }
...
private var _safetyPin01: ImageVector? = null
