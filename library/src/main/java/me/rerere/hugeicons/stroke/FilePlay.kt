...
val HugeIcons.FilePlay: ImageVector
    get() {
        if (_filePlay != null) {
            return _filePlay!!
        }
        ...
        path(
            ...
            moveTo(14.957f, 15.3384f)
            curveTo(14.8182f, 15.8756f, 14.1619f, 16.2552f, 12.8494f, 17.0144f)
            curveTo(11.5806f, 17.7484f, 10.9462f, 18.1153f, 10.4349f, 17.9678f)
            curveTo(10.2236f, 17.9068f, 10.031f, 17.791f, 9.87567f, 17.6315f)
            curveTo(9.5f, 17.2456f, 9.5f, 16.497f, 9.5f, 15f)
            curveTo(9.5f, 13.503f, 9.5f, 12.7544f, 9.87567f, 12.3685f)
            curveTo(10.031f, 12.209f, 10.2236f, 12.0932f, 10.4349f, 12.0322f)
            curveTo(10.9462f, 11.8847f, 11.5806f, 12.2516f, 12.8494f, 12.9856f)
            curveTo(14.1619f, 13.7448f, 14.8182f, 14.1244f, 14.957f, 14.6616f)
            curveTo(15.0143f, 14.8834f, 15.0143f, 15.1166f, 14.957f, 15.3384f)
            close()
        }
        }.build()
