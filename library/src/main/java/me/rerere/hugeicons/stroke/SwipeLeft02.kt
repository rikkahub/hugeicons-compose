...
val HugeIcons.SwipeLeft02: ImageVector
    get() {
        if (_swipeLeft02 != null) {
            return _swipeLeft02!!
        }
        _swipeLeft02 = ImageVector.Builder(
            name = "SwipeLeft02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(15f, 4.50195f)
        curveTo(15f, 3.80172f, 16.9943f, 2.49348f, 17.5f, 2.00195f)
        moveTo(15f, 4.50195f)
        curveTo(15f, 5.20218f, 16.9943f, 6.51042f, 17.5f, 7.00195f)
        }
...
private var _swipeLeft02: ImageVector? = null
