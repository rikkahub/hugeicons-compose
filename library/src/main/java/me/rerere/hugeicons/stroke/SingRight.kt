...
val HugeIcons.SingRight: ImageVector
    get() {
        if (_singRight != null) {
            return _singRight!!
        }
        _singRight = ImageVector.Builder(
            name = "SingRight",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            moveTo(16f, 16f)
            arcTo(2f, 2f, 0f, true, false, 12f, 16f)
            arcTo(2f, 2f, 0f, true, false, 16f, 16f)
            close()
        }
...
private var _singRight: ImageVector? = null
