...
val HugeIcons.FolderUnknown: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(18.625f, 20.75f)
            horizontalLineTo(18.5f)
            moveTo(18.75f, 20.75f)
            curveTo(18.75f, 20.8881f, 18.6381f, 21f, 18.5f, 21f)
            curveTo(18.3619f, 21f, 18.25f, 20.8881f, 18.25f, 20.75f)
            curveTo(18.25f, 20.6119f, 18.3619f, 20.5f, 18.5f, 20.5f)
            curveTo(18.6381f, 20.5f, 18.75f, 20.6119f, 18.75f, 20.75f)
            close()
        }
        }.build()
