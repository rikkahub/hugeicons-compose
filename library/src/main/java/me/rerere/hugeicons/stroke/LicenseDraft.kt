...
val HugeIcons.LicenseDraft: ImageVector
    get() {
        ...
        curveTo(6.97907f, 2f, 5.09347f, 2f, 3.9219f, 3.17156f)
        curveTo(2.75033f, 4.34312f, 2.75031f, 6.22872f, 2.75028f, 9.99993f)
        lineTo(2.75024f, 14f)
        curveTo(2.75021f, 17.7712f, 2.7502f, 19.6568f, 3.92173f, 20.8284f)
        curveTo(5.0933f, 21.9999f, 6.97898f, 22f, 10.7502f, 22f)
        }
        ...
        curveTo(13.5475f, 19.7f, 13.4027f, 19.8447f, 13.3265f, 20.0287f)
