...
val HugeIcons.SignalFull02: ImageVector
    get() {
        if (_signalFull02 != null) {
            return _signalFull02!!
        }
        _signalFull02 = ImageVector.Builder(
            name = "SignalFull02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            moveTo(21f, 17f)
            verticalLineTo(8f)
            curveTo(21f, 7.05719f, 21f, 6.58579f, 20.7071f, 6.29289f)
            curveTo(20.4142f, 6f, 19.9428f, 6f, 19f, 6f)
            curveTo(18.0572f, 6f, 17.5858f, 6f, 17.2929f, 6.29289f)
            curveTo(17f, 6.58579f, 17f, 7.05719f, 17f, 8f)
            verticalLineTo(17f)
            curveTo(17f, 17.9428f, 17f, 18.4142f, 17.2929f, 18.7071f)
            curveTo(17.5858f, 19f, 18.0572f, 19f, 19f, 19f)
            curveTo(19.9428f, 19f, 20.4142f, 19f, 20.7071f, 18.7071f)
            curveTo(21f, 18.4142f, 21f, 17.9428f, 21f, 17f)
            close()
        }
        }.build()
...
private var _signalFull02: ImageVector? = null
