...
val HugeIcons.BitcoinBag: ImageVector
    get() {
        if (_bitcoinBag != null) {
            return _bitcoinBag!!
        }
        _bitcoinBag = ImageVector.Builder(
            name = "BitcoinBag",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            moveTo(10.125f, 17.5f)
            lineTo(10.125f, 11.5f)
            moveTo(12f, 11.5f)
            verticalLineTo(10f)
            moveTo(12f, 19f)
            verticalLineTo(17.5f)
            moveTo(10.125f, 14.5f)
            horizontalLineTo(13.875f)
            moveTo(13.875f, 14.5f)
            curveTo(14.4963f, 14.5f, 15f, 15.0037f, 15f, 15.625f)
            verticalLineTo(16.375f)
            curveTo(15f, 16.9963f, 14.4963f, 17.5f, 13.875f, 17.5f)
            horizontalLineTo(9f)
            moveTo(13.875f, 14.5f)
            curveTo(14.4963f, 14.5f, 15f, 13.9963f, 15f, 13.375f)
            verticalLineTo(12.625f)
            curveTo(15f, 12.0037f, 14.4963f, 11.5f, 13.875f, 11.5f)
            horizontalLineTo(9f)
        }
...
private var _bitcoinBag: ImageVector? = null
