...
val HugeIcons.Gears: ImageVector
    get() {
        ...
        path(
            ...
            horizontalLineTo(8f)
            moveTo(8.5f, 7.25f)
            curveTo(8.5f, 7.52614f, 8.27614f, 7.75f, 8f, 7.75f)
            curveTo(7.72386f, 7.75f, 7.5f, 7.52614f, 7.5f, 7.25f)
            curveTo(7.5f, 6.97386f, 7.72386f, 6.75f, 8f, 6.75f)
            curveTo(8.27614f, 6.75f, 8.5f, 6.97386f, 8.5f, 7.25f)
            close()
        }
        ...
        path(
            ...
            moveTo(16.5f, 16.75f)
            curveTo(16.5f, 17.0261f, 16.2761f, 17.25f, 16f, 17.25f)
            curveTo(15.7239f, 17.25f, 15.5f, 17.0261f, 15.5f, 16.75f)
            curveTo(15.5f, 16.4739f, 15.7239f, 16.25f, 16f, 16.25f)
            curveTo(16.2761f, 16.25f, 16.5f, 16.4739f, 16.5f, 16.75f)
            close()
        }
        }.build()
