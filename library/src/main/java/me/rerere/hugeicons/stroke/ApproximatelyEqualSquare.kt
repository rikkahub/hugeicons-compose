...
val HugeIcons.ApproximatelyEqualSquare: ImageVector
    get() {
        if (_approximatelyEqualSquare != null) {
            return _approximatelyEqualSquare!!
        }
        _approximatelyEqualSquare = ImageVector.Builder(
...
private var _approximatelyEqualSquare: ImageVector? = null
