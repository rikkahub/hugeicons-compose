...
val HugeIcons.MoonLanding: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(15.25f, 17f)
            curveTo(15.25f, 17.1381f, 15.1381f, 17.25f, 15f, 17.25f)
            curveTo(14.8619f, 17.25f, 14.75f, 17.1381f, 14.75f, 17f)
            curveTo(14.75f, 16.8619f, 14.8619f, 16.75f, 15f, 16.75f)
            curveTo(15.1381f, 16.75f, 15.25f, 16.8619f, 15.25f, 17f)
            close()
        }
        }.build()
