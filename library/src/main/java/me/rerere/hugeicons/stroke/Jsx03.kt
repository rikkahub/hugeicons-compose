...
val HugeIcons.Jsx03: ImageVector
    get() {
        if (_jsx03 != null) {
            return _jsx03!!
        }
        _jsx03 = ImageVector.Builder(
            name = "Jsx03",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            moveTo(15.6618f, 14f)
            horizontalLineTo(14.4916f)
            curveTo(13.9393f, 14f, 13.4916f, 14.4477f, 13.4916f, 15f)
            verticalLineTo(15.5f)
            curveTo(13.4916f, 16.0523f, 13.9393f, 16.5f, 14.4916f, 16.5f)
            horizontalLineTo(14.6618f)
            curveTo(15.214f, 16.5f, 15.6618f, 16.9477f, 15.6618f, 17.5f)
            verticalLineTo(18f)
            curveTo(15.6618f, 18.5523f, 15.214f, 19f, 14.6618f, 19f)
            horizontalLineTo(13.4916f)
            moveTo(11f, 14f)
            verticalLineTo(17.5f)
            curveTo(11f, 18.3284f, 10.3284f, 19f, 9.5f, 19f)
            curveTo(8.67157f, 19f, 8f, 18.3284f, 8f, 17.5f)
            verticalLineTo(17f)
            moveTo(21f, 19f)
            lineTo(19.5f, 16.5f)
            moveTo(19.5f, 16.5f)
...
private var _jsx03: ImageVector? = null
