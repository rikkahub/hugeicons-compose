...
val HugeIcons.PanelRightOpen: ImageVector
    get() {
        ...
        moveTo(10f, 9f)
        lineTo(8.89181f, 9.87868f)
        curveTo(7.6306f, 10.8787f, 7f, 11.3787f, 7f, 12f)
        curveTo(7f, 12.6213f, 7.6306f, 13.1213f, 8.89181f, 14.1213f)
        lineTo(10f, 15f)
        }
        }.build()
