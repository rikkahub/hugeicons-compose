...
val HugeIcons.ShoppingBasketCheckIn02: ImageVector
    get() {
        if (_shoppingBasketCheckIn02 != null) {
            return _shoppingBasketCheckIn02!!
        }
        _shoppingBasketCheckIn02 = ImageVector.Builder(
        ...
        moveTo(16f, 16.5f)
        curveTo(16.4915f, 15.9943f, 17.7998f, 14f, 18.5f, 14f)
        moveTo(21f, 16.5f)
        curveTo(20.5085f, 15.9943f, 19.2002f, 14f, 18.5f, 14f)
        moveTo(18.5f, 14f)
        verticalLineTo(22f)
        }
...
private var _shoppingBasketCheckIn02: ImageVector? = null
