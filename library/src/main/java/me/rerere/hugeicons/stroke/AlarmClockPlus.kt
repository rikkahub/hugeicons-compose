...
val HugeIcons.AlarmClockPlus: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(12f, 21f)
            curveTo(16.6944f, 21f, 20.5f, 17.1944f, 20.5f, 12.5f)
        ...
        path(
            ...
            moveTo(18.1406f, 18.668f)
            lineTo(20.5006f, 20.998f)
        }
        ...
        path(
            ...
            moveTo(12.0009f, 9f)
            verticalLineTo(16f)
            moveTo(15.5059f, 12.495f)
            horizontalLineTo(8.50586f)
        }
        }.build()
