...
val HugeIcons.ShoppingCartRemove01: ImageVector
    get() {
        if (_shoppingCartRemove01 != null) {
            return _shoppingCartRemove01!!
        }
        _shoppingCartRemove01 = ImageVector.Builder(
        ...
        curveTo(15.8373f, 17f, 16.9129f, 17f, 17.7646f, 16.7416f)
        curveTo(19.6822f, 16.1599f, 21.1828f, 14.6593f, 21.7645f, 12.7417f)
        curveTo(21.9077f, 12.2695f, 21.9716f, 11.7373f, 22f, 11f)
        moveTo(14f, 6f)
...
private var _shoppingCartRemove01: ImageVector? = null
