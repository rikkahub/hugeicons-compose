...
val HugeIcons.MessageSquareHeart: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(11.9961f, 14.5f)
            curveTo(11.9961f, 14.5f, 7.99609f, 12.0294f, 7.99609f, 9.63889f)
            curveTo(7.99609f, 8.45761f, 8.8382f, 7.5f, 9.99609f, 7.5f)
            curveTo(10.5961f, 7.5f, 11.1961f, 7.70588f, 11.9961f, 8.52941f)
            curveTo(12.7961f, 7.70588f, 13.3961f, 7.5f, 13.9961f, 7.5f)
            curveTo(15.154f, 7.5f, 15.9961f, 8.45761f, 15.9961f, 9.63889f)
            curveTo(15.9961f, 12.0294f, 11.9961f, 14.5f, 11.9961f, 14.5f)
            close()
        }
        }.build()
