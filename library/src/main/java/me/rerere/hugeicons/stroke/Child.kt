...
val HugeIcons.Child: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(8.5f, 11f)
            curveTo(8.5f, 11.1381f, 8.38807f, 11.25f, 8.25f, 11.25f)
            curveTo(8.11193f, 11.25f, 8f, 11.1381f, 8f, 11f)
            curveTo(8f, 10.8619f, 8.11193f, 10.75f, 8.25f, 10.75f)
            curveTo(8.38807f, 10.75f, 8.5f, 10.8619f, 8.5f, 11f)
            close()
            moveTo(15.5f, 11f)
            curveTo(15.5f, 11.1381f, 15.6119f, 11.25f, 15.75f, 11.25f)
            curveTo(15.8881f, 11.25f, 16f, 11.1381f, 16f, 11f)
            curveTo(16f, 10.8619f, 15.8881f, 10.75f, 15.75f, 10.75f)
            curveTo(15.6119f, 10.75f, 15.5f, 10.8619f, 15.5f, 11f)
            close()
        }
