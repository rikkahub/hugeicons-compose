...
val HugeIcons.Typescript02: ImageVector
    get() {
        if (_typescript02 != null) {
            return _typescript02!!
        }
        _typescript02 = ImageVector.Builder(
            name = "Typescript02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            curveTo(14.4477f, 16f, 14f, 16.4477f, 14f, 17f)
            verticalLineTo(18f)
            curveTo(14f, 18.5523f, 14.4477f, 19f, 15f, 19f)
            horizontalLineTo(17.0002f)
            curveTo(17.5525f, 19f, 18.0002f, 19.4477f, 18.0002f, 20f)
            verticalLineTo(21f)
            curveTo(18.0002f, 21.5523f, 17.5525f, 22f, 17.0002f, 22f)
...
private var _typescript02: ImageVector? = null
