...
val HugeIcons.Upload02: ImageVector
    get() {
        ...
        curveTo(7.49228f, 6.92738f, 6.80182f, 7.68602f, 7.04953f, 8.3183f)
        curveTo(7.05858f, 8.34138f, 7.0684f, 8.36414f, 7.07899f, 8.38653f)
        curveTo(7.34917f, 8.95795f, 8.24467f, 8.99712f, 9.99989f, 8.9998f)
        ...
        curveTo(13.9999f, 16.1975f, 13.9999f, 15.965f, 13.9999f, 15.5f)
        verticalLineTo(8.9998f)
        curveTo(15.7551f, 8.99712f, 16.6506f, 8.95796f, 16.9208f, 8.38653f)
        curveTo(16.9314f, 8.36414f, 16.9412f, 8.34138f, 16.9503f, 8.3183f)
        }
