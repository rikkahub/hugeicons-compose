...
val HugeIcons.InboxCheck: ImageVector
    get() {
        ...
        curveTo(10.011f, 16.9824f, 9.20365f, 16.2375f, 8.80046f, 15.4296f)
        curveTo(8.42934f, 14.686f, 7.76769f, 13.9824f, 6.92558f, 13.9824f)
        horizontalLineTo(1.99992f)
        }
        ...
        curveTo(7.026f, 22f, 4.78486f, 22f, 3.39239f, 20.6076f)
        curveTo(1.99992f, 19.215f, 1.99992f, 16.9739f, 1.99992f, 12.4916f)
        curveTo(1.99992f, 8.00935f, 1.99992f, 5.76821f, 3.39239f, 4.37574f)
        curveTo(4.78486f, 2.98328f, 7.026f, 2.98328f, 11.5083f, 2.98328f)
        }
        ...
        curveTo(22.0001f, 8.18312f, 20.2167f, 9.96647f, 18.0169f, 9.96647f)
        curveTo(15.817f, 9.96647f, 14.0336f, 8.18312f, 14.0336f, 5.98324f)
        curveTo(14.0336f, 3.78336f, 15.817f, 2f, 18.0169f, 2f)
