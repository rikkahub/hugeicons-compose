...
val HugeIcons.Walpaper: ImageVector
    get() {
        if (_walpaper != null) {
            return _walpaper!!
        }
        _walpaper = ImageVector.Builder(
            name = "Walpaper",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            curveTo(12.5f, 20.3284f, 13.1716f, 21f, 14f, 21f)
            moveTo(14f, 21f)
        ...
        path(
            ...
            moveTo(9f, 8.5f)
            arcTo(1.5f, 1.5f, 0f, true, false, 6f, 8.5f)
            arcTo(1.5f, 1.5f, 0f, true, false, 9f, 8.5f)
            close()
        }
        ...
        path(
            ...
            moveTo(21.8486f, 13.8348f)
            lineTo(17.1826f, 8.74465f)
            curveTo(16.7476f, 8.27016f, 16.1335f, 8f, 15.4898f, 8f)
            curveTo(14.858f, 8f, 14.2542f, 8.2603f, 13.8203f, 8.71962f)
            lineTo(6.14807f, 16.8432f)
        }
        }.build()
...
private var _walpaper: ImageVector? = null
