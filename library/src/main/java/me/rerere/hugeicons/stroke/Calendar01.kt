...
val HugeIcons.Calendar01: ImageVector
    get() {
        if (_calendar01 != null) {
            return _calendar01!!
        }
        _calendar01 = ImageVector.Builder(
            name = "Calendar01",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(10f, 18.5002f)
        lineTo(9.99999f, 13.8474f)
        curveTo(9.99999f, 13.6557f, 9.86325f, 13.5002f, 9.69458f, 13.5002f)
        horizontalLineTo(9f)
        moveTo(14f, 18.4983f)
        lineTo(15.4855f, 13.8923f)
        curveTo(15.4951f, 13.8626f, 15.5f, 13.8315f, 15.5f, 13.8002f)
        curveTo(15.5f, 13.6346f, 15.3657f, 13.5002f, 15.2f, 13.5002f)
        lineTo(13f, 13.5f)
        }
        }.build()
...
private var _calendar01: ImageVector? = null
