...
val HugeIcons.BubbleChatPreview: ImageVector
    get() {
        if (_bubbleChatPreview != null) {
            return _bubbleChatPreview!!
        }
        _bubbleChatPreview = ImageVector.Builder(
        ...
        moveTo(17f, 12f)
        curveTo(17f, 12f, 14.958f, 15f, 12f, 15f)
        curveTo(9.04197f, 15f, 7f, 12f, 7f, 12f)
        curveTo(7f, 12f, 9f, 9f, 12f, 9f)
        curveTo(15f, 9f, 17f, 12f, 17f, 12f)
        }
...
private var _bubbleChatPreview: ImageVector? = null
