...
val HugeIcons.ViewSidebarRight: ImageVector
    get() {
        if (_viewSidebarRight != null) {
            return _viewSidebarRight!!
        }
        _viewSidebarRight = ImageVector.Builder(
            name = "ViewSidebarRight",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _viewSidebarRight: ImageVector? = null
