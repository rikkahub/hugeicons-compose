...
val HugeIcons.FolderSync: ImageVector
    get() {
        ...
        moveTo(13f, 15f)
        lineTo(14f, 17f)
        curveTo(14.2426f, 15.3039f, 15.7368f, 14f, 17.5f, 14f)
        curveTo(18.6894f, 14f, 19.7402f, 14.5933f, 20.3726f, 15.5f)
        moveTo(22f, 20f)
        lineTo(21f, 18f)
        curveTo(20.7574f, 19.6961f, 19.2632f, 21f, 17.5f, 21f)
        curveTo(16.3106f, 21f, 15.2598f, 20.4067f, 14.6273f, 19.5f)
        }
        }.build()
