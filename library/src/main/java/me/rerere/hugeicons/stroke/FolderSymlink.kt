...
val HugeIcons.FolderSymlink: ImageVector
    get() {
        ...
        path(
            ...
            curveTo(2.93416f, 19.0052f, 2.64986f, 18.2157f, 2.50661f, 17.3979f)
            curveTo(2.27647f, 16.0841f, 2.16139f, 15.4271f, 2.76083f, 14.7136f)
            curveTo(3.36026f, 14f, 4.21042f, 14f, 5.91073f, 14f)
            lineTo(11f, 14f)
            moveTo(12f, 7f)
