...
val HugeIcons.FileChartLine: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(8f, 17.5f)
            lineTo(10f, 15.5f)
            curveTo(10.2726f, 15.2274f, 10.4089f, 15.0911f, 10.556f, 15.0182f)
            curveTo(10.8358f, 14.8796f, 11.1642f, 14.8796f, 11.444f, 15.0182f)
            curveTo(11.5911f, 15.0911f, 11.7274f, 15.2274f, 12f, 15.5f)
            curveTo(12.2726f, 15.7726f, 12.4089f, 15.9089f, 12.556f, 15.9818f)
            curveTo(12.8358f, 16.1204f, 13.1642f, 16.1204f, 13.444f, 15.9818f)
            curveTo(13.5911f, 15.9089f, 13.7274f, 15.7726f, 14f, 15.5f)
            lineTo(16f, 13.5f)
        }
