...
val HugeIcons.BubbleChatDownload01: ImageVector
    get() {
        if (_bubbleChatDownload01 != null) {
            return _bubbleChatDownload01!!
        }
        _bubbleChatDownload01 = ImageVector.Builder(
        ...
        moveTo(15f, 10.5f)
        curveTo(15f, 10.5f, 12.7906f, 13.5f, 12f, 13.5f)
        curveTo(11.2094f, 13.5f, 9.00002f, 10.5f, 9.00002f, 10.5f)
        moveTo(12f, 13f)
        verticalLineTo(7.5f)
        moveTo(9.00002f, 16.5f)
...
private var _bubbleChatDownload01: ImageVector? = null
