...
val HugeIcons.CancelSquare: ImageVector
    get() {
        if (_cancelSquare != null) {
            return _cancelSquare!!
        }
        _cancelSquare = ImageVector.Builder(
            name = "CancelSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _cancelSquare: ImageVector? = null
