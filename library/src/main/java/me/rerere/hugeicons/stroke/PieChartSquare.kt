...
val HugeIcons.PieChartSquare: ImageVector
    get() {
        ...
        curveTo(2.5f, 7.77039f, 2.5f, 5.65552f, 3.69797f, 4.25288f)
        curveTo(3.86808f, 4.05371f, 4.05358f, 3.8682f, 4.25276f, 3.69809f)
        curveTo(5.6554f, 2.50012f, 7.77027f, 2.50012f, 12f, 2.50012f)
        curveTo(16.2297f, 2.50012f, 18.3446f, 2.50012f, 19.7472f, 3.69809f)
        curveTo(19.9464f, 3.8682f, 20.1319f, 4.05371f, 20.302f, 4.25288f)
        curveTo(21.5f, 5.65552f, 21.5f, 7.77039f, 21.5f, 12.0001f)
        curveTo(21.5f, 16.2299f, 21.5f, 18.3447f, 20.302f, 19.7474f)
        curveTo(20.1319f, 19.9465f, 19.9464f, 20.132f, 19.7472f, 20.3022f)
        curveTo(18.3446f, 21.5001f, 16.2297f, 21.5001f, 12f, 21.5001f)
        curveTo(7.77027f, 21.5001f, 5.6554f, 21.5001f, 4.25276f, 20.3022f)
        curveTo(4.05358f, 20.132f, 3.86808f, 19.9465f, 3.69797f, 19.7474f)
        curveTo(2.5f, 18.3447f, 2.5f, 16.2299f, 2.5f, 12.0001f)
        }
