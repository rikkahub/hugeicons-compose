...
val HugeIcons.CalendarSetting01: ImageVector
    get() {
        ...
        path(
            ...
            curveTo(19.2402f, 19.993f, 18.4293f, 20.5f, 17.5f, 20.5f)
            moveTo(15.3291f, 16.7593f)
            curveTo(15.1197f, 17.1249f, 15f, 17.5485f, 15f, 18f)
            curveTo(15f, 18.4514f, 15.1196f, 18.8749f, 15.329f, 19.2404f)
            curveTo(15.7598f, 19.993f, 16.5707f, 20.5f, 17.5f, 20.5f)
            moveTo(17.5f, 20.5f)
            lineTo(17.5f, 22f)
            moveTo(17.5f, 15.5f)
