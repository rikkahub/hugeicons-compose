...
val HugeIcons.ShieldCheck: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(8.49219f, 11.8333f)
            curveTo(8.49219f, 11.8333f, 9.36719f, 11.8333f, 10.2422f, 13.5f)
            curveTo(10.2422f, 13.5f, 13.0216f, 9.33333f, 15.4922f, 8.5f)
        }
        }.build()
