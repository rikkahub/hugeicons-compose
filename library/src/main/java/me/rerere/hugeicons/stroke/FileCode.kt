...
val HugeIcons.FileCode: ImageVector
    get() {
        if (_fileCode != null) {
            return _fileCode!!
        }
        ...
        path(
            ...
            moveTo(10f, 18f)
            curveTo(10f, 18f, 7.50004f, 16.1588f, 7.50003f, 15.5f)
            curveTo(7.50003f, 14.8412f, 10f, 13f, 10f, 13f)
        }
        ...
        path(
            ...
            moveTo(14f, 18f)
            curveTo(14f, 18f, 16.5f, 16.1588f, 16.5f, 15.5f)
            curveTo(16.5f, 14.8412f, 14f, 13f, 14f, 13f)
        }
