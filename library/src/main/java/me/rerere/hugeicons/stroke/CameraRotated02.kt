...
val HugeIcons.CameraRotated02: ImageVector
    get() {
        if (_cameraRotated02 != null) {
            return _cameraRotated02!!
        }
        _cameraRotated02 = ImageVector.Builder(
        ...
        moveTo(12.9999f, 12.5f)
        lineTo(10.4999f, 13f)
        lineTo(8.99994f, 10.5f)
        moveTo(11.8541f, 16f)
        curveTo(12.5592f, 16.6224f, 13.4855f, 17f, 14.4999f, 17f)
        curveTo(16.7091f, 17f, 18.4999f, 15.2091f, 18.4999f, 13f)
        curveTo(18.4999f, 10.7909f, 16.7091f, 9f, 14.4999f, 9f)
        curveTo(12.4601f, 9f, 10.7769f, 10.5268f, 10.5309f, 12.5f)
        }
        }.build()
...
private var _cameraRotated02: ImageVector? = null
