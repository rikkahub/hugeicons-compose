...
val HugeIcons.Shield02: ImageVector
    get() {
        if (_shield02 != null) {
            return _shield02!!
        }
        _shield02 = ImageVector.Builder(
            name = "Shield02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(15f, 11f)
        curveTo(15f, 12.6568f, 13.6569f, 14f, 12f, 14f)
        curveTo(10.3431f, 14f, 9f, 12.6568f, 9f, 11f)
        curveTo(9f, 9.34314f, 10.3431f, 8f, 12f, 8f)
        curveTo(13.6569f, 8f, 15f, 9.34314f, 15f, 11f)
        }
        }.build()
...
private var _shield02: ImageVector? = null
