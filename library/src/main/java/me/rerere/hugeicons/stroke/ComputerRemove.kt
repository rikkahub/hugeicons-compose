...
val HugeIcons.ComputerRemove: ImageVector
    get() {
        if (_computerRemove != null) {
            return _computerRemove!!
        }
        _computerRemove = ImageVector.Builder(
            name = "ComputerRemove",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _computerRemove: ImageVector? = null
