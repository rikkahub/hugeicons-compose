...
val HugeIcons.ScreenAddToHome: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(13.75f, 19f)
            curveTo(13.75f, 19.1381f, 13.6381f, 19.25f, 13.5f, 19.25f)
            curveTo(13.3619f, 19.25f, 13.25f, 19.1381f, 13.25f, 19f)
            curveTo(13.25f, 18.8619f, 13.3619f, 18.75f, 13.5f, 18.75f)
            curveTo(13.6381f, 18.75f, 13.75f, 18.8619f, 13.75f, 19f)
            close()
        }
