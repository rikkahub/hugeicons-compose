...
val HugeIcons.CallOutgoing01: ImageVector
    get() {
        if (_callOutgoing01 != null) {
            return _callOutgoing01!!
        }
        _callOutgoing01 = ImageVector.Builder(
            name = "CallOutgoing01",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(18f, 10f)
        curveTo(18.6068f, 9.41016f, 21f, 7.84027f, 21f, 7f)
        curveTo(21f, 6.15973f, 18.6068f, 4.58984f, 18f, 4f)
        moveTo(20.5f, 7f)
...
private var _callOutgoing01: ImageVector? = null
