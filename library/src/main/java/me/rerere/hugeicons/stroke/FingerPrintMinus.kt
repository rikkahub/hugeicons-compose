...
val HugeIcons.FingerPrintMinus: ImageVector
    get() {
        if (_fingerPrintMinus != null) {
            return _fingerPrintMinus!!
        }
        _fingerPrintMinus = ImageVector.Builder(
...
private var _fingerPrintMinus: ImageVector? = null
