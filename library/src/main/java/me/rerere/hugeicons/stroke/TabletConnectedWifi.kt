...
val HugeIcons.TabletConnectedWifi: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(17.1f, 15.9f)
            curveTo(17.1f, 15.9552f, 17.0552f, 16f, 17f, 16f)
            curveTo(16.9448f, 16f, 16.9f, 15.9552f, 16.9f, 15.9f)
            curveTo(16.9f, 15.8448f, 16.9448f, 15.8f, 17f, 15.8f)
            curveTo(17.0552f, 15.8f, 17.1f, 15.8448f, 17.1f, 15.9f)
            close()
        }
        }.build()
