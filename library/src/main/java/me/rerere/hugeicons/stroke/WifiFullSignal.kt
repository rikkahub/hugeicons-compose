...
val HugeIcons.WifiFullSignal: ImageVector
    get() {
        if (_wifiFullSignal != null) {
            return _wifiFullSignal!!
        }
        _wifiFullSignal = ImageVector.Builder(
            name = "WifiFullSignal",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(21f, 11f)
        curveTo(15.4548f, 7f, 8.54519f, 7f, 3f, 11f)
        }
...
private var _wifiFullSignal: ImageVector? = null
