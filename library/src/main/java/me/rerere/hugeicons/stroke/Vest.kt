...
val HugeIcons.Vest: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(10.75f, 14f)
            curveTo(10.75f, 14.1381f, 10.6381f, 14.25f, 10.5f, 14.25f)
            curveTo(10.3619f, 14.25f, 10.25f, 14.1381f, 10.25f, 14f)
            curveTo(10.25f, 13.8619f, 10.3619f, 13.75f, 10.5f, 13.75f)
            curveTo(10.6381f, 13.75f, 10.75f, 13.8619f, 10.75f, 14f)
            close()
        }
        }.build()
