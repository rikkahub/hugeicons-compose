...
val HugeIcons.Appointment01: ImageVector
    get() {
        if (_appointment01 != null) {
            return _appointment01!!
        }
        _appointment01 = ImageVector.Builder(
            name = "Appointment01",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(13f, 19.5f)
        curveTo(13f, 19.5f, 14.3485f, 20.0067f, 15f, 22f)
        curveTo(15f, 22f, 18.1765f, 17f, 21f, 16f)
        }
        }.build()
...
private var _appointment01: ImageVector? = null
