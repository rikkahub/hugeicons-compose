...
val HugeIcons.AiChat01: ImageVector
    get() {
        if (_aiChat01 != null) {
            return _aiChat01!!
        }
        _aiChat01 = ImageVector.Builder(
            name = "AiChat01",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            moveTo(10.487f, 7.00098f)
            verticalLineTo(8.98f)
            moveTo(7f, 10.5014f)
            horizontalLineTo(9.05198f)
            moveTo(15.0231f, 10.5014f)
            horizontalLineTo(17.075f)
            moveTo(15.0231f, 13.4746f)
            horizontalLineTo(17.075f)
            moveTo(7f, 13.4746f)
            horizontalLineTo(9.05198f)
            moveTo(10.487f, 15.0202f)
            verticalLineTo(16.9992f)
            moveTo(13.5125f, 15.0202f)
            verticalLineTo(16.9992f)
            moveTo(13.5017f, 7.00098f)
            verticalLineTo(8.98f)
            moveTo(10.052f, 14.9685f)
            horizontalLineTo(14.0231f)
            curveTo(14.5753f, 14.9685f, 15.0231f, 14.5208f, 15.0231f, 13.9685f)
            verticalLineTo(9.98f)
            curveTo(15.0231f, 9.42771f, 14.5753f, 8.98f, 14.0231f, 8.98f)
            horizontalLineTo(10.052f)
            curveTo(9.49969f, 8.98f, 9.05198f, 9.42771f, 9.05198f, 9.98f)
            verticalLineTo(13.9685f)
            curveTo(9.05198f, 14.5208f, 9.49969f, 14.9685f, 10.052f, 14.9685f)
            close()
        }
        }.build()
...
private var _aiChat01: ImageVector? = null
