...
val HugeIcons.ImageRotationClockwise: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(11.625f, 11.5f)
            horizontalLineTo(11.5f)
            moveTo(11.75f, 11.5f)
            curveTo(11.75f, 11.6381f, 11.6381f, 11.75f, 11.5f, 11.75f)
            curveTo(11.3619f, 11.75f, 11.25f, 11.6381f, 11.25f, 11.5f)
            curveTo(11.25f, 11.3619f, 11.3619f, 11.25f, 11.5f, 11.25f)
            curveTo(11.6381f, 11.25f, 11.75f, 11.3619f, 11.75f, 11.5f)
            close()
        }
        }.build()
