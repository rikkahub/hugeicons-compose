...
val HugeIcons.ChatSpark: ImageVector
    get() {
        if (_chatSpark != null) {
            return _chatSpark!!
        }
        _chatSpark = ImageVector.Builder(
            name = "ChatSpark",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(11.9649f, 6.52864f)
        curveTo(11.9727f, 6.49045f, 12.0273f, 6.49045f, 12.0351f, 6.52864f)
        curveTo(12.4402f, 8.51077f, 13.9892f, 10.0598f, 15.9714f, 10.4649f)
        curveTo(16.0095f, 10.4727f, 16.0095f, 10.5273f, 15.9714f, 10.5351f)
        curveTo(13.9892f, 10.9402f, 12.4402f, 12.4892f, 12.0351f, 14.4714f)
        curveTo(12.0273f, 14.5095f, 11.9727f, 14.5095f, 11.9649f, 14.4714f)
        curveTo(11.5598f, 12.4892f, 10.0108f, 10.9402f, 8.02864f, 10.5351f)
        curveTo(7.99045f, 10.5273f, 7.99045f, 10.4727f, 8.02864f, 10.4649f)
        curveTo(10.0108f, 10.0598f, 11.5598f, 8.51077f, 11.9649f, 6.52864f)
        }
        }.build()
...
private var _chatSpark: ImageVector? = null
