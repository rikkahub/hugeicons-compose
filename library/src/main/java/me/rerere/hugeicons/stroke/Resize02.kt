...
val HugeIcons.Resize02: ImageVector
    get() {
        if (_resize02 != null) {
            return _resize02!!
        }
        _resize02 = ImageVector.Builder(
            name = "Resize02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        lineTo(20f, 4.5f)
        moveTo(16f, 4.5f)
        curveTo(16f, 5.06018f, 17.4943f, 6.10678f, 18f, 6.5f)
        moveTo(16f, 4.5f)
        curveTo(16f, 3.93982f, 17.4943f, 2.89322f, 18f, 2.5f)
        }
        ...
        lineTo(2.5f, 4.5f)
        moveTo(6.5f, 4.5f)
        curveTo(6.5f, 3.93982f, 5.0057f, 2.89322f, 4.5f, 2.5f)
        moveTo(6.5f, 4.5f)
        curveTo(6.5f, 5.06018f, 5.0057f, 6.10678f, 4.5f, 6.5f)
        }
        }.build()
...
private var _resize02: ImageVector? = null
