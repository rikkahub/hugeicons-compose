...
val HugeIcons.Scooter04: ImageVector
    get() {
        if (_scooter04 != null) {
            return _scooter04!!
        }
        _scooter04 = ImageVector.Builder(
            name = "Scooter04",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            moveTo(22f, 18f)
            arcTo(2f, 2f, 0f, true, false, 18f, 18f)
            arcTo(2f, 2f, 0f, true, false, 22f, 18f)
            close()
        }
...
private var _scooter04: ImageVector? = null
