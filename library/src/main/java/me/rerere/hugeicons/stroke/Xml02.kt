...
val HugeIcons.Xml02: ImageVector
    get() {
        if (_xml02 != null) {
            return _xml02!!
        }
        _xml02 = ImageVector.Builder(
            name = "Xml02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(19f, 14f)
        verticalLineTo(17f)
        curveTo(19f, 17.9428f, 19f, 18.4142f, 19.2929f, 18.7071f)
        curveTo(19.5858f, 19f, 20.0572f, 19f, 21f, 19f)
        moveTo(7f, 14f)
        lineTo(8.5f, 16.5f)
        moveTo(8.5f, 16.5f)
        lineTo(10f, 19f)
...
private var _xml02: ImageVector? = null
