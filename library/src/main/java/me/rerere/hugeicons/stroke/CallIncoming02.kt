...
val HugeIcons.CallIncoming02: ImageVector
    get() {
        if (_callIncoming02 != null) {
            return _callIncoming02!!
        }
        _callIncoming02 = ImageVector.Builder(
            name = "CallIncoming02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(14.733f, 9.26889f)
        lineTo(20f, 4.00192f)
        moveTo(19f, 9.70593f)
        curveTo(17.7447f, 9.81515f, 14.9531f, 10.3246f, 14.3152f, 9.68668f)
        curveTo(13.6774f, 9.04881f, 14.1868f, 6.25726f, 14.296f, 5.00192f)
        }
        }.build()
...
private var _callIncoming02: ImageVector? = null
