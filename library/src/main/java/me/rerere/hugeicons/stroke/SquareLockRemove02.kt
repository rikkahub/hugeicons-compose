...
val HugeIcons.SquareLockRemove02: ImageVector
    get() {
        if (_squareLockRemove02 != null) {
            return _squareLockRemove02!!
        }
        _squareLockRemove02 = ImageVector.Builder(
        ...
        path(
            ...
            moveTo(17.9428f, 17.0572f)
            lineTo(17f, 18f)
            moveTo(17f, 18f)
            lineTo(16.0572f, 18.9428f)
            moveTo(17f, 18f)
            lineTo(17.9428f, 18.9428f)
            moveTo(17f, 18f)
            lineTo(16.0572f, 17.0572f)
            moveTo(19.8284f, 20.8284f)
            curveTo(18.2663f, 22.3905f, 15.7337f, 22.3905f, 14.1716f, 20.8284f)
            curveTo(12.6095f, 19.2663f, 12.6095f, 16.7337f, 14.1716f, 15.1716f)
            curveTo(15.7337f, 13.6095f, 18.2663f, 13.6095f, 19.8284f, 15.1716f)
            curveTo(21.3905f, 16.7337f, 21.3905f, 19.2663f, 19.8284f, 20.8284f)
            close()
        }
...
private var _squareLockRemove02: ImageVector? = null
