...
val HugeIcons.SquareLockPassword: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(10f, 15.5f)
            curveTo(10f, 15.7761f, 9.77614f, 16f, 9.5f, 16f)
            curveTo(9.22386f, 16f, 9f, 15.7761f, 9f, 15.5f)
            curveTo(9f, 15.2239f, 9.22386f, 15f, 9.5f, 15f)
            curveTo(9.77614f, 15f, 10f, 15.2239f, 10f, 15.5f)
            close()
        }
        ...
        path(
            ...
            verticalLineTo(15.75f)
            moveTo(15f, 15.5f)
            curveTo(15f, 15.7761f, 14.7761f, 16f, 14.5f, 16f)
            curveTo(14.2239f, 16f, 14f, 15.7761f, 14f, 15.5f)
            curveTo(14f, 15.2239f, 14.2239f, 15f, 14.5f, 15f)
            curveTo(14.7761f, 15f, 15f, 15.2239f, 15f, 15.5f)
            close()
        }
