...
val HugeIcons.MessageUpload01: ImageVector
    get() {
        if (_messageUpload01 != null) {
            return _messageUpload01!!
        }
        _messageUpload01 = ImageVector.Builder(
        ...
        moveTo(17f, 4.5f)
        curveTo(17.4915f, 3.9943f, 18.7998f, 2f, 19.5f, 2f)
        moveTo(22f, 4.5f)
        curveTo(21.5085f, 3.9943f, 20.2002f, 2f, 19.5f, 2f)
        moveTo(19.5f, 2f)
        verticalLineTo(10f)
        }
        }.build()
...
private var _messageUpload01: ImageVector? = null
