...
val HugeIcons.FileVerified: ImageVector
    get() {
        if (_fileVerified != null) {
            return _fileVerified!!
        }
        _fileVerified = ImageVector.Builder(
            name = "FileVerified",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(12f, 20f)
        curveTo(12f, 20f, 13f, 20f, 14f, 22f)
        curveTo(14f, 22f, 17.1765f, 17f, 20f, 16f)
        }
...
private var _fileVerified: ImageVector? = null
