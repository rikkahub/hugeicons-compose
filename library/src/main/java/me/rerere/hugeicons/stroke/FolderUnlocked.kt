...
val HugeIcons.FolderUnlocked: ImageVector
    get() {
        if (_folderUnlocked != null) {
            return _folderUnlocked!!
        }
        _folderUnlocked = ImageVector.Builder(
            name = "FolderUnlocked",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        curveTo(19.0781f, 12f, 19.5907f, 12.2803f, 19.9094f, 12.7124f)
        moveTo(22f, 18.25f)
...
private var _folderUnlocked: ImageVector? = null
