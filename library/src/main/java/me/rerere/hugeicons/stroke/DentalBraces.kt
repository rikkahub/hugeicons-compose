...
val HugeIcons.DentalBraces: ImageVector
    get() {
        if (_dentalBraces != null) {
            return _dentalBraces!!
        }
        _dentalBraces = ImageVector.Builder(
            name = "DentalBraces",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(10.387f, 9.38704f)
        curveTo(9.87099f, 9.9031f, 9.87099f, 12.0969f, 10.387f, 12.613f)
        curveTo(10.9031f, 13.129f, 13.0969f, 13.129f, 13.613f, 12.613f)
        curveTo(14.129f, 12.0969f, 14.129f, 9.9031f, 13.613f, 9.38704f)
        curveTo(13.0969f, 8.87099f, 10.9031f, 8.87099f, 10.387f, 9.38704f)
        }
...
private var _dentalBraces: ImageVector? = null
