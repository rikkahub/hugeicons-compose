...
val HugeIcons.ComputerDollar: ImageVector
    get() {
        if (_computerDollar != null) {
            return _computerDollar!!
        }
        _computerDollar = ImageVector.Builder(
            name = "ComputerDollar",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            moveTo(12f, 7f)
            curveTo(10.8954f, 7f, 10f, 7.67157f, 10f, 8.5f)
            curveTo(10f, 9.32843f, 10.8954f, 10f, 12f, 10f)
            curveTo(13.1046f, 10f, 14f, 10.6716f, 14f, 11.5f)
            curveTo(14f, 12.3284f, 13.1046f, 13f, 12f, 13f)
            moveTo(12f, 7f)
            curveTo(12.8708f, 7f, 13.6116f, 7.4174f, 13.8862f, 8f)
            moveTo(12f, 7f)
            verticalLineTo(6f)
            moveTo(12f, 13f)
            curveTo(11.1292f, 13f, 10.3884f, 12.5826f, 10.1138f, 12f)
            moveTo(12f, 13f)
            verticalLineTo(14f)
        }
...
private var _computerDollar: ImageVector? = null
