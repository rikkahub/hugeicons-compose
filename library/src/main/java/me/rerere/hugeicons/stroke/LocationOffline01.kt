...
val HugeIcons.LocationOffline01: ImageVector
    get() {
        if (_locationOffline01 != null) {
            return _locationOffline01!!
        }
        _locationOffline01 = ImageVector.Builder(
        ...
        path(
            ...
            moveTo(9f, 9f)
            curveTo(8.66525f, 9.53668f, 8.5f, 10.3209f, 8.5f, 11f)
            curveTo(8.5f, 12.933f, 10.067f, 14.5f, 12f, 14.5f)
            curveTo(12.6598f, 14.5f, 13.4732f, 14.3174f, 14f, 14f)
        }
        ...
        path(
            ...
            moveTo(11.5f, 7.53544f)
            curveTo(11.6633f, 7.51209f, 11.8302f, 7.5f, 12f, 7.5f)
            curveTo(13.933f, 7.5f, 15.5f, 9.067f, 15.5f, 11f)
            curveTo(15.5f, 11.1698f, 15.4879f, 11.3367f, 15.4646f, 11.5f)
        }
...
private var _locationOffline01: ImageVector? = null
