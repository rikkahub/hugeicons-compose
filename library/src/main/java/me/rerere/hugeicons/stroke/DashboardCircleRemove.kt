...
val HugeIcons.DashboardCircleRemove: ImageVector
    get() {
        if (_dashboardCircleRemove != null) {
            return _dashboardCircleRemove!!
        }
        _dashboardCircleRemove = ImageVector.Builder(
...
private var _dashboardCircleRemove: ImageVector? = null
