...
val HugeIcons.UserRoundCog: ImageVector
    get() {
        ...
        path(
            ...
            curveTo(19.7402f, 19.493f, 18.9293f, 20f, 18f, 20f)
            moveTo(15.8291f, 16.2593f)
            curveTo(15.6197f, 16.6249f, 15.5f, 17.0485f, 15.5f, 17.5f)
            curveTo(15.5f, 17.9514f, 15.6196f, 18.3749f, 15.829f, 18.7404f)
            curveTo(16.2598f, 19.493f, 17.0707f, 20f, 18f, 20f)
            moveTo(18f, 20f)
            lineTo(18f, 21.5f)
            moveTo(18f, 15f)
