...
val HugeIcons.FileManagement: ImageVector
    get() {
        if (_fileManagement != null) {
            return _fileManagement!!
        }
        _fileManagement = ImageVector.Builder(
            name = "FileManagement",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(8f, 9.77273f)
        curveTo(9.76731f, 9.77273f, 11.2f, 8.30748f, 11.2f, 6.5f)
        curveTo(11.2f, 4.69252f, 9.76731f, 3.22727f, 8f, 3.22727f)
        moveTo(8f, 9.77273f)
        curveTo(6.23269f, 9.77273f, 4.8f, 8.30748f, 4.8f, 6.5f)
        curveTo(4.8f, 4.69252f, 6.23269f, 3.22727f, 8f, 3.22727f)
        moveTo(8f, 9.77273f)
        verticalLineTo(11f)
        moveTo(8f, 3.22727f)
        verticalLineTo(2f)
        moveTo(5.0913f, 4.71488f)
        lineTo(4.00045f, 4.04545f)
        moveTo(12f, 8.95455f)
        lineTo(10.9092f, 8.28512f)
        moveTo(10.9087f, 4.71488f)
        lineTo(11.9996f, 4.04545f)
        moveTo(4f, 8.95455f)
        lineTo(5.09085f, 8.28512f)
        }
        }.build()
...
private var _fileManagement: ImageVector? = null
