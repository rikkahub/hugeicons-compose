...
val HugeIcons.CalendarCheckOut02: ImageVector
    get() {
        if (_calendarCheckOut02 != null) {
            return _calendarCheckOut02!!
        }
        _calendarCheckOut02 = ImageVector.Builder(
        ...
        moveTo(13.5f, 18.5f)
        curveTo(14.0057f, 18.0085f, 16f, 16.7002f, 16f, 16f)
        curveTo(16f, 15.2998f, 14.0057f, 13.9915f, 13.5f, 13.5f)
        moveTo(15.5f, 16f)
        lineTo(9f, 16f)
        }
        }.build()
...
private var _calendarCheckOut02: ImageVector? = null
