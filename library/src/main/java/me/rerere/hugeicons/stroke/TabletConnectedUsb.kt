...
val HugeIcons.TabletConnectedUsb: ImageVector
    get() {
        ...
        curveTo(19.6234f, 12.6584f, 20.1554f, 13.1903f, 20.8115f, 13.1903f)
        curveTo(21.4677f, 13.1903f, 21.9996f, 12.6584f, 21.9996f, 12.0023f)
        curveTo(21.9996f, 11.3461f, 21.4677f, 10.8142f, 20.8115f, 10.8142f)
        curveTo(20.1554f, 10.8142f, 19.6234f, 11.3461f, 19.6234f, 12.0023f)
        moveTo(19.6234f, 12.0023f)
        lineTo(10.0254f, 12.0062f)
        moveTo(12.385f, 8.52051f)
        ...
        curveTo(15.7187f, 15.4331f, 16.0728f, 15.1769f, 16.2138f, 14.7991f)
        lineTo(17.2313f, 12.0032f)
        }
        }.build()
