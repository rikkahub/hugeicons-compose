...
val HugeIcons.UnfoldMoreUp: ImageVector
    get() {
        if (_unfoldMoreUp != null) {
            return _unfoldMoreUp!!
        }
        _unfoldMoreUp = ImageVector.Builder(
            name = "UnfoldMoreUp",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _unfoldMoreUp: ImageVector? = null
