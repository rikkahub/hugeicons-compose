...
val HugeIcons.FolderAttachment: ImageVector
    get() {
        if (_folderAttachment != null) {
            return _folderAttachment!!
        }
        _folderAttachment = ImageVector.Builder(
        ...
        moveTo(21f, 15.4615f)
        verticalLineTo(17.9231f)
        curveTo(21f, 19.6224f, 19.6569f, 21f, 18f, 21f)
        curveTo(16.3431f, 21f, 15f, 19.6224f, 15f, 17.9231f)
        verticalLineTo(14.5385f)
        curveTo(15f, 13.6888f, 15.6716f, 13f, 16.5f, 13f)
        curveTo(17.3284f, 13f, 18f, 13.6888f, 18f, 14.5385f)
        verticalLineTo(17.9231f)
        }
        }.build()
...
private var _folderAttachment: ImageVector? = null
