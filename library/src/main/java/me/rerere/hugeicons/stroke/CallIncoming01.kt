...
val HugeIcons.CallIncoming01: ImageVector
    get() {
        if (_callIncoming01 != null) {
            return _callIncoming01!!
        }
        _callIncoming01 = ImageVector.Builder(
            name = "CallIncoming01",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(16f, 10f)
        curveTo(15.3932f, 9.41016f, 13f, 7.84027f, 13f, 7f)
        curveTo(13f, 6.15973f, 15.3932f, 4.58984f, 16f, 4f)
        moveTo(13.5f, 7f)
...
private var _callIncoming01: ImageVector? = null
