...
val HugeIcons.UsbError: ImageVector
    get() {
        ...
        curveTo(12.8693f, 14.5617f, 12.2679f, 15.4549f, 11.7237f, 16.3859f)
        curveTo(11.4243f, 16.8982f, 11.1379f, 17.4117f, 10.9026f, 17.8424f)
        curveTo(10.5052f, 18.5697f, 9.95898f, 19.2975f, 10.0134f, 20.1249f)
