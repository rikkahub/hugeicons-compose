...
val HugeIcons.Simcard02: ImageVector
    get() {
        if (_simcard02 != null) {
            return _simcard02!!
        }
        _simcard02 = ImageVector.Builder(
            name = "Simcard02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(7f, 14.5f)
        curveTo(7f, 16.1499f, 7f, 16.9749f, 7.43934f, 17.4874f)
        curveTo(7.87868f, 18f, 8.58579f, 18f, 10f, 18f)
        horizontalLineTo(14f)
        curveTo(15.4142f, 18f, 16.1213f, 18f, 16.5607f, 17.4874f)
        curveTo(17f, 16.9749f, 17f, 16.1499f, 17f, 14.5f)
        moveTo(7f, 14.5f)
        curveTo(7f, 12.8501f, 7f, 12.0251f, 7.43934f, 11.5126f)
        curveTo(7.87868f, 11f, 8.58579f, 11f, 10f, 11f)
        horizontalLineTo(14f)
        curveTo(15.4142f, 11f, 16.1213f, 11f, 16.5607f, 11.5126f)
        curveTo(17f, 12.0251f, 17f, 12.8501f, 17f, 14.5f)
        moveTo(7f, 14.5f)
        horizontalLineTo(9f)
        moveTo(17f, 14.5f)
...
private var _simcard02: ImageVector? = null
