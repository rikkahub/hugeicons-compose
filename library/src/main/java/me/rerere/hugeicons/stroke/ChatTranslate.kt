...
val HugeIcons.ChatTranslate: ImageVector
    get() {
        if (_chatTranslate != null) {
            return _chatTranslate!!
        }
        _chatTranslate = ImageVector.Builder(
            name = "ChatTranslate",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(9f, 15f)
        curveTo(11.7116f, 13.1923f, 13.8451f, 10.7747f, 14.5f, 7.5f)
        moveTo(13.5f, 13.5f)
        curveTo(11.8882f, 12.2106f, 11.0341f, 10.8345f, 10.6761f, 10f)
        }
        }.build()
...
private var _chatTranslate: ImageVector? = null
