...
val HugeIcons.Judge: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(7.5f, 11f)
            verticalLineTo(12f)
            curveTo(7.5f, 13.1046f, 6.60457f, 14f, 5.5f, 14f)
            curveTo(4.39543f, 14f, 3.5f, 13.1046f, 3.5f, 12f)
            curveTo(3.5f, 11.3276f, 3.83187f, 10.7326f, 4.34075f, 10.37f)
            curveTo(3.82499f, 9.91208f, 3.5f, 9.24399f, 3.5f, 8.5f)
            curveTo(3.5f, 7.11929f, 4.61929f, 6f, 6f, 6f)
            curveTo(6f, 3.79086f, 8.5f, 2f, 12f, 2f)
            curveTo(15.5f, 2f, 18f, 3.79086f, 18f, 6f)
            curveTo(19.3807f, 6f, 20.5f, 7.11929f, 20.5f, 8.5f)
            curveTo(20.5f, 9.24399f, 20.175f, 9.91208f, 19.6592f, 10.37f)
            curveTo(20.1681f, 10.7326f, 20.5f, 11.3276f, 20.5f, 12f)
            curveTo(20.5f, 13.1046f, 19.6046f, 14f, 18.5f, 14f)
            curveTo(17.3954f, 14f, 16.5f, 13.1046f, 16.5f, 12f)
            verticalLineTo(11f)
