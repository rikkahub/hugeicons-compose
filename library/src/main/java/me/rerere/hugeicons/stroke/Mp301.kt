...
val HugeIcons.Mp301: ImageVector
    get() {
        if (_mp301 != null) {
            return _mp301!!
        }
        _mp301 = ImageVector.Builder(
            name = "Mp301",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(16.5f, 17.001f)
        curveTo(16.5f, 16.4487f, 16.9477f, 16.001f, 17.5f, 16.001f)
        horizontalLineTo(19f)
        curveTo(19.5523f, 16.001f, 20f, 16.4487f, 20f, 17.001f)
        verticalLineTo(18.001f)
        curveTo(20f, 18.5533f, 19.5523f, 19.001f, 19f, 19.001f)
        moveTo(18f, 19.001f)
        horizontalLineTo(19f)
        moveTo(4f, 22.001f)
        ...
        moveTo(10.5f, 22.001f)
        verticalLineTo(19.501f)
        moveTo(10.5f, 19.501f)
        verticalLineTo(16.001f)
        horizontalLineTo(12.25f)
        curveTo(13.2165f, 16.001f, 14f, 16.7845f, 14f, 17.751f)
        curveTo(14f, 18.7175f, 13.2165f, 19.501f, 12.25f, 19.501f)
        horizontalLineTo(10.5f)
        moveTo(19f, 19.001f)
        curveTo(19.5523f, 19.001f, 20f, 19.4487f, 20f, 20.001f)
        verticalLineTo(21.001f)
        curveTo(20f, 21.5533f, 19.5523f, 22.001f, 19f, 22.001f)
        horizontalLineTo(17.5f)
        curveTo(16.9477f, 22.001f, 16.5f, 21.5533f, 16.5f, 21.001f)
        }
        }.build()
...
private var _mp301: ImageVector? = null
