...
val HugeIcons.MessageCircleCheck: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(8.49609f, 12.3333f)
            curveTo(8.49609f, 12.3333f, 9.37109f, 12.3333f, 10.2461f, 14f)
            curveTo(10.2461f, 14f, 13.0255f, 9.83333f, 15.4961f, 9f)
        }
