...
val HugeIcons.CameraAutomatically02: ImageVector
    get() {
        if (_cameraAutomatically02 != null) {
            return _cameraAutomatically02!!
        }
        _cameraAutomatically02 = ImageVector.Builder(
        ...
        moveTo(17.5f, 16.5f)
        lineTo(15.1682f, 9.97087f)
        curveTo(15.0673f, 9.68849f, 14.7998f, 9.5f, 14.5f, 9.5f)
        curveTo(14.2002f, 9.5f, 13.9327f, 9.68849f, 13.8318f, 9.97087f)
        lineTo(11.5f, 16.5f)
        moveTo(13f, 14f)
        horizontalLineTo(16f)
        }
...
private var _cameraAutomatically02: ImageVector? = null
