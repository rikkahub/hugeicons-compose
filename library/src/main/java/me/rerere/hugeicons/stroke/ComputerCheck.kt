...
val HugeIcons.ComputerCheck: ImageVector
    get() {
        if (_computerCheck != null) {
            return _computerCheck!!
        }
        _computerCheck = ImageVector.Builder(
            name = "ComputerCheck",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(8.5f, 10.5006f)
        curveTo(8.5f, 10.5006f, 9.5f, 11.0006f, 10.25f, 12.5006f)
        curveTo(10.25f, 12.5006f, 13.0294f, 8.33394f, 15.5f, 7.50061f)
        }
        }.build()
...
private var _computerCheck: ImageVector? = null
