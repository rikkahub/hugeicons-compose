...
val HugeIcons.DeliveredSent: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(19f, 19.0001f)
            arcTo(2f, 2f, 0f, true, false, 15f, 19.0001f)
            arcTo(2f, 2f, 0f, true, false, 19f, 19.0001f)
            close()
        }
        ...
        path(
            ...
            moveTo(9f, 19.0001f)
            arcTo(2f, 2f, 0f, true, false, 5f, 19.0001f)
            arcTo(2f, 2f, 0f, true, false, 9f, 19.0001f)
            close()
        }
