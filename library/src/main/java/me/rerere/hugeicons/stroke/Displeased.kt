...
val HugeIcons.Displeased: ImageVector
    get() {
        if (_displeased != null) {
            return _displeased!!
        }
        _displeased = ImageVector.Builder(
            name = "Displeased",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(9f, 15.6837f)
        curveTo(11.0949f, 14.3069f, 13.504f, 15.1434f, 15f, 17f)
        }
...
private var _displeased: ImageVector? = null
