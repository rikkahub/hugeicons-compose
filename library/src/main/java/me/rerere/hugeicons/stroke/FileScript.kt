...
val HugeIcons.FileScript: ImageVector
    get() {
        if (_fileScript != null) {
            return _fileScript!!
        }
        _fileScript = ImageVector.Builder(
            name = "FileScript",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(14.3267f, 22f)
        lineTo(13.1155f, 20.9142f)
        curveTo(12.3718f, 20.2475f, 12f, 19.9142f, 12f, 19.5f)
        curveTo(12f, 19.0858f, 12.3718f, 18.7525f, 13.1155f, 18.0858f)
        lineTo(14.3267f, 17f)
        moveTo(17.6733f, 22f)
        lineTo(18.8845f, 20.9142f)
        curveTo(19.6282f, 20.2475f, 20f, 19.9142f, 20f, 19.5f)
        curveTo(20f, 19.0858f, 19.6282f, 18.7525f, 18.8845f, 18.0858f)
        lineTo(17.6733f, 17f)
        }
        }.build()
...
private var _fileScript: ImageVector? = null
