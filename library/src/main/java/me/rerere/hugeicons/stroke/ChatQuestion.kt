...
val HugeIcons.ChatQuestion: ImageVector
    get() {
        if (_chatQuestion != null) {
            return _chatQuestion!!
        }
        _chatQuestion = ImageVector.Builder(
            name = "ChatQuestion",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            curveTo(14f, 8.57777f, 13.755f, 9.09832f, 13.3632f, 9.46343f)
            curveTo(12.7572f, 10.0282f, 12f, 10.6716f, 12f, 11.5f)
        }
        ...
        path(
            ...
            moveTo(12.125f, 14.75f)
            horizontalLineTo(12f)
            moveTo(12.25f, 14.75f)
            curveTo(12.25f, 14.8881f, 12.1381f, 15f, 12f, 15f)
            curveTo(11.8619f, 15f, 11.75f, 14.8881f, 11.75f, 14.75f)
            curveTo(11.75f, 14.6119f, 11.8619f, 14.5f, 12f, 14.5f)
            curveTo(12.1381f, 14.5f, 12.25f, 14.6119f, 12.25f, 14.75f)
            close()
        }
        }.build()
