...
val HugeIcons.ChatQuestion: ImageVector
    get() {
        ...
        moveTo(9.5f, 8.5f)
        curveTo(9.5f, 7.11929f, 10.6193f, 6f, 12f, 6f)
        curveTo(13.3807f, 6f, 14.5f, 7.11929f, 14.5f, 8.5f)
        curveTo(14.5f, 9.53529f, 13.8707f, 10.4236f, 12.9737f, 10.8033f)
        curveTo(12.4651f, 11.0186f, 12f, 11.4477f, 12f, 12f)
        }
        }.build()
