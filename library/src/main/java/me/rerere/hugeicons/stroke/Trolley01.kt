...
val HugeIcons.Trolley01: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(12f, 19.5f)
            arcTo(1.5f, 1.5f, 0f, true, false, 9f, 19.5f)
            arcTo(1.5f, 1.5f, 0f, true, false, 12f, 19.5f)
            close()
        }
        ...
        path(
            ...
            moveTo(19f, 19.5f)
            arcTo(1.5f, 1.5f, 0f, true, false, 16f, 19.5f)
            arcTo(1.5f, 1.5f, 0f, true, false, 19f, 19.5f)
            close()
        }
