...
val HugeIcons.SafeDelivery01: ImageVector
    get() {
        if (_safeDelivery01 != null) {
            return _safeDelivery01!!
        }
        _safeDelivery01 = ImageVector.Builder(
            name = "SafeDelivery01",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        path(
            ...
            curveTo(11.1144f, 12f, 10.1716f, 12f, 9.58579f, 11.4142f)
            curveTo(9f, 10.8284f, 9f, 9.88562f, 9f, 8f)
            verticalLineTo(6f)
            curveTo(9f, 4.11438f, 9f, 3.17157f, 9.58579f, 2.58579f)
            curveTo(10.1716f, 2f, 11.1144f, 2f, 13f, 2f)
            horizontalLineTo(15f)
            curveTo(16.8856f, 2f, 17.8284f, 2f, 18.4142f, 2.58579f)
            curveTo(19f, 3.17157f, 19f, 4.11438f, 19f, 6f)
            verticalLineTo(8f)
            curveTo(19f, 9.88562f, 19f, 10.8284f, 18.4142f, 11.4142f)
            curveTo(17.8284f, 12f, 16.8856f, 12f, 15f, 12f)
            close()
        }
...
private var _safeDelivery01: ImageVector? = null
