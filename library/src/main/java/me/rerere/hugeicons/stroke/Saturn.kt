...
val HugeIcons.Saturn: ImageVector
    get() {
        ...
        path(
            ...
            curveTo(10.7641f, 17.4921f, 12.5191f, 16.0025f, 14.2608f, 14.2608f)
            curveTo(16.0025f, 12.5191f, 17.4921f, 10.7641f, 18.6244f, 9.17452f)
            curveTo(20.6193f, 6.37425f, 21.5056f, 4.08733f, 20.7092f, 3.29084f)
            curveTo(19.9127f, 2.49436f, 17.6258f, 3.38071f, 14.8255f, 5.37555f)
