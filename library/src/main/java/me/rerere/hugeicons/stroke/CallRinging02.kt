...
val HugeIcons.CallRinging02: ImageVector
    get() {
        if (_callRinging02 != null) {
            return _callRinging02!!
        }
        _callRinging02 = ImageVector.Builder(
            name = "CallRinging02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(17.5f, 11.002f)
        lineTo(20f, 11f)
        moveTo(13f, 6.50195f)
        verticalLineTo(4f)
        moveTo(17.9497f, 6.05025f)
        lineTo(16.181f, 7.819f)
        }
        }.build()
...
private var _callRinging02: ImageVector? = null
