...
val HugeIcons.BitcoinRectangle: ImageVector
    get() {
        if (_bitcoinRectangle != null) {
            return _bitcoinRectangle!!
        }
        _bitcoinRectangle = ImageVector.Builder(
...
private var _bitcoinRectangle: ImageVector? = null
