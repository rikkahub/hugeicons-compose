...
val HugeIcons.PhoneArrowDown: ImageVector
    get() {
        if (_phoneArrowDown != null) {
            return _phoneArrowDown!!
        }
        _phoneArrowDown = ImageVector.Builder(
            name = "PhoneArrowDown",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(9f, 12.5f)
        curveTo(9f, 12.5f, 11.2095f, 15.5f, 12f, 15.5f)
        curveTo(12.7906f, 15.5f, 15f, 12.5f, 15f, 12.5f)
        moveTo(12f, 15f)
        verticalLineTo(8.5f)
        }
        }.build()
...
private var _phoneArrowDown: ImageVector? = null
