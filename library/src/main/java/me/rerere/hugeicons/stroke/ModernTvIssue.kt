...
val HugeIcons.ModernTvIssue: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(12.0746f, 13.3492f)
            horizontalLineTo(11.9996f)
            moveTo(12.1496f, 13.3492f)
            curveTo(12.1496f, 13.4321f, 12.0825f, 13.4992f, 11.9996f, 13.4992f)
            curveTo(11.9168f, 13.4992f, 11.8496f, 13.4321f, 11.8496f, 13.3492f)
            curveTo(11.8496f, 13.2664f, 11.9168f, 13.1992f, 11.9996f, 13.1992f)
            curveTo(12.0825f, 13.1992f, 12.1496f, 13.2664f, 12.1496f, 13.3492f)
            close()
        }
        }.build()
