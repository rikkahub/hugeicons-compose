...
val HugeIcons.Calling: ImageVector
    get() {
        if (_calling != null) {
            return _calling!!
        }
        _calling = ImageVector.Builder(
            name = "Calling",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(13f, 4f)
        curveTo(16.866f, 4f, 20f, 7.13401f, 20f, 11f)
        moveTo(13f, 8f)
        curveTo(14.6569f, 8f, 16f, 9.34315f, 16f, 11f)
        }
        }.build()
...
private var _calling: ImageVector? = null
