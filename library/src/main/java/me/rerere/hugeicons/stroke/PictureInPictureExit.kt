...
val HugeIcons.PictureInPictureExit: ImageVector
    get() {
        ...
        moveTo(6.00391f, 11.501f)
        lineTo(6.00391f, 9.00098f)
        curveTo(5.95641f, 8.42657f, 6.40047f, 7.97715f, 7.00391f, 8.00098f)
        lineTo(9.50391f, 8.00098f)
        moveTo(11.0039f, 13.001f)
        lineTo(7.00391f, 9.00098f)
        }
        }.build()
