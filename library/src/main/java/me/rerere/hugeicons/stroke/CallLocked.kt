...
val HugeIcons.CallLocked: ImageVector
    get() {
        if (_callLocked != null) {
            return _callLocked!!
        }
        _callLocked = ImageVector.Builder(
            name = "CallLocked",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        curveTo(17.6046f, 3f, 18.5f, 3.89543f, 18.5f, 5f)
        verticalLineTo(6.5f)
        }
...
private var _callLocked: ImageVector? = null
