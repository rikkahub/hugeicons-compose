...
val HugeIcons.Raw02: ImageVector
    get() {
        if (_raw02 != null) {
            return _raw02!!
        }
        _raw02 = ImageVector.Builder(
            name = "Raw02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        curveTo(8.94036f, 14f, 9.5f, 14.5596f, 9.5f, 15.25f)
        curveTo(9.5f, 15.9404f, 8.94036f, 16.5f, 8.25f, 16.5f)
...
private var _raw02: ImageVector? = null
