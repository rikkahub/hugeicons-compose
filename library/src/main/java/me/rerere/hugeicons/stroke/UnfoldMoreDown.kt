...
val HugeIcons.UnfoldMoreDown: ImageVector
    get() {
        if (_unfoldMoreDown != null) {
            return _unfoldMoreDown!!
        }
        _unfoldMoreDown = ImageVector.Builder(
            name = "UnfoldMoreDown",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _unfoldMoreDown: ImageVector? = null
