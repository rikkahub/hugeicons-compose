...
val HugeIcons.SwipeUp04: ImageVector
    get() {
        if (_swipeUp04 != null) {
            return _swipeUp04!!
        }
        _swipeUp04 = ImageVector.Builder(
            name = "SwipeUp04",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        lineTo(18f, 8f)
        moveTo(18f, 2f)
        curveTo(17.2998f, 2f, 15.9915f, 3.9943f, 15.5f, 4.5f)
        moveTo(18f, 2f)
        curveTo(18.7002f, 2f, 20.0085f, 3.9943f, 20.5f, 4.5f)
        }
        }.build()
...
private var _swipeUp04: ImageVector? = null
