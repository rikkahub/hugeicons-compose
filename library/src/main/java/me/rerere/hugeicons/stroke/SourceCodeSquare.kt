...
val HugeIcons.SourceCodeSquare: ImageVector
    get() {
        if (_sourceCodeSquare != null) {
            return _sourceCodeSquare!!
        }
        _sourceCodeSquare = ImageVector.Builder(
...
private var _sourceCodeSquare: ImageVector? = null
