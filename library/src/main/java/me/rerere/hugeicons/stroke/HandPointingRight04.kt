...
val HugeIcons.HandPointingRight04: ImageVector
    get() {
        ...
        path(
            ...
            lineTo(19.9954f, 7.75178f)
            curveTo(20.8264f, 7.75178f, 21.5f, 8.42415f, 21.5f, 9.25355f)
            curveTo(21.5f, 10.083f, 20.8264f, 10.7553f, 19.9954f, 10.7553f)
            horizontalLineTo(16.4892f)
            lineTo(13.485f, 10.7553f)
