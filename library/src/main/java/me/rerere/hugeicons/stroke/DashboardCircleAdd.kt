...
val HugeIcons.DashboardCircleAdd: ImageVector
    get() {
        if (_dashboardCircleAdd != null) {
            return _dashboardCircleAdd!!
        }
        _dashboardCircleAdd = ImageVector.Builder(
...
private var _dashboardCircleAdd: ImageVector? = null
