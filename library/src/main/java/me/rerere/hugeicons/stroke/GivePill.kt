...
val HugeIcons.GivePill: ImageVector
    get() {
        if (_givePill != null) {
            return _givePill!!
        }
        _givePill = ImageVector.Builder(
            name = "GivePill",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(11f, 5f)
        verticalLineTo(9f)
        curveTo(11f, 10.6569f, 12.3431f, 12f, 14f, 12f)
        curveTo(15.6569f, 12f, 17f, 10.6569f, 17f, 9f)
        verticalLineTo(5f)
        curveTo(17f, 3.34315f, 15.6569f, 2f, 14f, 2f)
        curveTo(12.3431f, 2f, 11f, 3.34315f, 11f, 5f)
        }
...
private var _givePill: ImageVector? = null
