...
val HugeIcons.PathfinderMerge: ImageVector
    get() {
        if (_pathfinderMerge != null) {
            return _pathfinderMerge!!
        }
        _pathfinderMerge = ImageVector.Builder(
        ...
        curveTo(8.77606f, 15f, 9f, 15.2239f, 9f, 15.5f)
        ...
        curveTo(15.224f, 9f, 15f, 8.77597f, 15f, 8.5f)
...
private var _pathfinderMerge: ImageVector? = null
