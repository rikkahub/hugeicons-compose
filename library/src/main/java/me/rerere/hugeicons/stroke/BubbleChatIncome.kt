...
val HugeIcons.BubbleChatIncome: ImageVector
    get() {
        if (_bubbleChatIncome != null) {
            return _bubbleChatIncome!!
        }
        _bubbleChatIncome = ImageVector.Builder(
        ...
        moveTo(11.5f, 9f)
        curveTo(11.5f, 9f, 8.50001f, 11.2095f, 8.5f, 12f)
        curveTo(8.49999f, 12.7906f, 11.5f, 15f, 11.5f, 15f)
        moveTo(9f, 12f)
        lineTo(15.5f, 12f)
        }
        }.build()
...
private var _bubbleChatIncome: ImageVector? = null
