...
val HugeIcons.SaveMoneyYen: ImageVector
    get() {
        if (_saveMoneyYen != null) {
            return _saveMoneyYen!!
        }
        _saveMoneyYen = ImageVector.Builder(
            name = "SaveMoneyYen",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(12f, 5.5f)
        curveTo(12.1667f, 6.31481f, 12.3993f, 7.16667f, 13.9993f, 8.05556f)
        moveTo(13.9993f, 8.05556f)
        curveTo(15.5993f, 7.16667f, 15.8327f, 6.31481f, 15.9993f, 5.5f)
        moveTo(13.9993f, 8.05556f)
...
private var _saveMoneyYen: ImageVector? = null
