...
val HugeIcons.FileLocked: ImageVector
    get() {
        if (_fileLocked != null) {
            return _fileLocked!!
        }
        _fileLocked = ImageVector.Builder(
            name = "FileLocked",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(20f, 11.0039f)
        curveTo(20f, 11.0039f, 20f, 9.43383f, 19.8478f, 9.06613f)
        ...
        curveTo(17.4665f, 13f, 18.25f, 13.7835f, 18.25f, 14.75f)
...
private var _fileLocked: ImageVector? = null
