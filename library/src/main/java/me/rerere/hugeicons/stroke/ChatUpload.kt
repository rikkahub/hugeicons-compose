...
val HugeIcons.ChatUpload: ImageVector
    get() {
        if (_chatUpload != null) {
            return _chatUpload!!
        }
        _chatUpload = ImageVector.Builder(
            name = "ChatUpload",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(15f, 9.99998f)
        curveTo(15f, 9.99998f, 12.7906f, 7.00001f, 12f, 7f)
        curveTo(11.2094f, 6.99999f, 9.00002f, 10f, 9.00002f, 10f)
        moveTo(12f, 7.5f)
        verticalLineTo(14f)
        }
        }.build()
...
private var _chatUpload: ImageVector? = null
