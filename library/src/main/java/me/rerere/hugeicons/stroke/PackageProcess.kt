...
val HugeIcons.PackageProcess: ImageVector
    get() {
        if (_packageProcess != null) {
            return _packageProcess!!
        }
        _packageProcess = ImageVector.Builder(
            name = "PackageProcess",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _packageProcess: ImageVector? = null
