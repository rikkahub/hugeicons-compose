...
val HugeIcons.CandyOff: ImageVector
    get() {
        if (_candyOff != null) {
            return _candyOff!!
        }
        ...
        path(
            ...
            moveTo(8.5f, 8.5f)
            lineTo(7.44975f, 9.55025f)
            curveTo(6.52149f, 10.4785f, 6f, 11.7375f, 6f, 13.0503f)
            curveTo(6f, 15.7839f, 8.21608f, 18f, 10.9497f, 18f)
            curveTo(12.2625f, 18f, 13.5215f, 17.4785f, 14.4497f, 16.5503f)
            lineTo(15.5f, 15.5f)
            moveTo(11.3144f, 6.31436f)
            curveTo(11.8643f, 6.10841f, 12.4517f, 6f, 13.0503f, 6f)
            curveTo(15.7839f, 6f, 18f, 8.21608f, 18f, 10.9497f)
            curveTo(18f, 11.5483f, 17.8916f, 12.1357f, 17.6856f, 12.6856f)
        }
