...
val HugeIcons.IceCream04: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(8.48899f, 8.99984f)
            curveTo(6.44796f, 8.99984f, 5.28562f, 11.4092f, 6.48388f, 13f)
            horizontalLineTo(18.5145f)
            curveTo(19.5986f, 11.5609f, 18.7733f, 9.37521f, 16.9689f, 9.04176f)
