...
val HugeIcons.Pdf02: ImageVector
    get() {
        if (_pdf02 != null) {
            return _pdf02!!
        }
        _pdf02 = ImageVector.Builder(
            name = "Pdf02",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        curveTo(14.7325f, 14f, 15.5f, 14.7462f, 15.5f, 15.6667f)
        verticalLineTo(17.3333f)
        curveTo(15.5f, 18.2538f, 14.7325f, 19f, 13.7857f, 19f)
...
private var _pdf02: ImageVector? = null
