...
val HugeIcons.BubbleChatOutcome: ImageVector
    get() {
        if (_bubbleChatOutcome != null) {
            return _bubbleChatOutcome!!
        }
        _bubbleChatOutcome = ImageVector.Builder(
        ...
        moveTo(12.5f, 9f)
        curveTo(12.5f, 9f, 15.5f, 11.2095f, 15.5f, 12f)
        curveTo(15.5f, 12.7906f, 12.5f, 15f, 12.5f, 15f)
        moveTo(15f, 12f)
        lineTo(8.5f, 12f)
        }
        }.build()
...
private var _bubbleChatOutcome: ImageVector? = null
