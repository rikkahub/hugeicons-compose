...
val HugeIcons.FolderClosed: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(2f, 13f)
            curveTo(2.06427f, 12.3499f, 2.20951f, 11.9124f, 2.53777f, 11.5858f)
            curveTo(3.12654f, 11f, 4.07416f, 11f, 5.9694f, 11f)
            horizontalLineTo(18.0306f)
            curveTo(19.9258f, 11f, 20.8735f, 11f, 21.4622f, 11.5858f)
            curveTo(21.7905f, 11.9124f, 21.9357f, 12.3499f, 22f, 13f)
        }
