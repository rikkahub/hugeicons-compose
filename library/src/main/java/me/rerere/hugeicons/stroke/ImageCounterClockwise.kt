...
val HugeIcons.ImageCounterClockwise: ImageVector
    get() {
        ...
        path(
            ...
            moveTo(7.75f, 11.5f)
            curveTo(7.75f, 11.6381f, 7.63807f, 11.75f, 7.5f, 11.75f)
            curveTo(7.36193f, 11.75f, 7.25f, 11.6381f, 7.25f, 11.5f)
            curveTo(7.25f, 11.3619f, 7.36193f, 11.25f, 7.5f, 11.25f)
            curveTo(7.63807f, 11.25f, 7.75f, 11.3619f, 7.75f, 11.5f)
            close()
        }
        }.build()
