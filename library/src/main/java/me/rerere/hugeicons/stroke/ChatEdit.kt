...
val HugeIcons.ChatEdit: ImageVector
    get() {
        if (_chatEdit != null) {
            return _chatEdit!!
        }
        _chatEdit = ImageVector.Builder(
            name = "ChatEdit",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        moveTo(10.2367f, 13.6527f)
        lineTo(8.5f, 14f)
        lineTo(8.84733f, 12.2633f)
        curveTo(8.91788f, 11.9106f, 9.09126f, 11.5866f, 9.34563f, 11.3323f)
        lineTo(13.4111f, 7.26684f)
        curveTo(13.7668f, 6.91105f, 14.3437f, 6.91105f, 14.6995f, 7.26684f)
        lineTo(15.2332f, 7.80052f)
        curveTo(15.5889f, 8.15631f, 15.5889f, 8.73316f, 15.2332f, 9.08895f)
        lineTo(11.1677f, 13.1544f)
        curveTo(10.9134f, 13.4087f, 10.5894f, 13.5821f, 10.2367f, 13.6527f)
        }
        }.build()
